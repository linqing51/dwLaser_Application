...
RoundPlot::RoundPlot(QWidget *parent) : QWidget(parent)
{
    ...
    connect(timer1, SIGNAL(timeout()), this, SLOT(updatefire()));
    timer1->start();
...
//    painter.drawPixmap(0,0,width,height, QPixmap(":/new/prefix1/image/logo"));
...
//    painter.rotate(180);
//    painter.scale(side / 800.0 * tempfire /100 , side / 800.0 * tempfire /100);
    painter.drawPixmap(-width/2,0,width,height, QPixmap(":/new/prefix1/image/logo"));
