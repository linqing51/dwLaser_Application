...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : FS_NO_Pin NFC_STA_Pin */
  GPIO_InitStruct.Pin = FS_NO_Pin|NFC_STA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : INTERLOCK_NC_Pin ESTOP_NC_Pin */
  ...
  /*Configure GPIO pins : LAS_TEC_Pin LAS_FAN_Pin */
  ...
  /*Configure GPIO pin : LAS_AIM_Pin */
