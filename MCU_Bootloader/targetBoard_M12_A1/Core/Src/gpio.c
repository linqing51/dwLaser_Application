...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, TICK_LED_Pin|ERR_LED_Pin|HGC5615_CS_Pin|HGC5615_SCK_Pin
                          |HGC5615_SDI_Pin|LAS_AIM_PWM_Pin|LAS_FAN_PWM_Pin|GREEN_LED_PWM_Pin
                          |RED_LED_PWM_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : FS_NC_Pin ESTOP_NC_Pin PC9 */
  GPIO_InitStruct.Pin = FS_NC_Pin|ESTOP_NC_Pin|GPIO_PIN_9;
  ...
  /*Configure GPIO pins : PB2 LAS_FAN_FG_Pin FS_NO_Pin BLUE_LED_PWM_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_2|LAS_FAN_FG_Pin|FS_NO_Pin|BLUE_LED_PWM_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
