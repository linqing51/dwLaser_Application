...
#define MPR_PWM5_Pin GPIO_PIN_11
#define MPR_PWM5_GPIO_Port GPIOF
#define SLD_PWM0_Pin GPIO_PIN_12
#define SLD_PWM0_GPIO_Port GPIOF
#define EDAC_DIN_Pin GPIO_PIN_13
#define EDAC_DIN_GPIO_Port GPIOF
#define EDAC_SCLK_Pin GPIO_PIN_14
#define EDAC_SCLK_GPIO_Port GPIOF
#define EDAC_SYNC_Pin GPIO_PIN_15
#define EDAC_SYNC_GPIO_Port GPIOF
#define MPR_PWM3_Pin GPIO_PIN_0
#define MPR_PWM3_GPIO_Port GPIOG
#define MPR_PWM4_Pin GPIO_PIN_1
#define MPR_PWM4_GPIO_Port GPIOG
#define MPR_PWM0_Pin GPIO_PIN_7
#define MPR_PWM0_GPIO_Port GPIOE
#define MPR_PWM1_Pin GPIO_PIN_8
#define MPR_PWM1_GPIO_Port GPIOE
#define MPR_PWM2_Pin GPIO_PIN_9
#define MPR_PWM2_GPIO_Port GPIOE
...
#define SPK_EN_Pin GPIO_PIN_8
#define SPK_EN_GPIO_Port GPIOD
