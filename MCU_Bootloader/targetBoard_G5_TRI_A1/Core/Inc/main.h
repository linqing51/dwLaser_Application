...
#define MPU_USB0_PSON_Pin GPIO_PIN_14
#define MPU_USB0_PSON_GPIO_Port GPIOE
#define MPU_USB0_ID_Pin GPIO_PIN_15
#define MPU_USB0_ID_GPIO_Port GPIOE
...
#define USB_EXT_PSON_Pin GPIO_PIN_3
#define USB_EXT_PSON_GPIO_Port GPIOD
#define MCU_USB0_PSON_Pin GPIO_PIN_4
#define MCU_USB0_PSON_GPIO_Port GPIOD
#define GDDC_TX_Pin GPIO_PIN_5
#define GDDC_TX_GPIO_Port GPIOD
#define GDDC_RX_Pin GPIO_PIN_6
#define GDDC_RX_GPIO_Port GPIOD
#define MCU_USB0_ID_Pin GPIO_PIN_7
#define MCU_USB0_ID_GPIO_Port GPIOD
