...
//EDAC
// 引脚电平控制宏
#define DAC8568_SYNC_HIGH  										HAL_GPIO_WritePin(DAC8568_NSS_GPIO_Port, DAC8568_NSS_Pin, GPIO_PIN_SET)
#define DAC8568_SYNC_LOW   										HAL_GPIO_WritePin(DAC8568_NSS_GPIO_Port, DAC8568_NSS_Pin, GPIO_PIN_RESET)

#define DAC8568_SCK_HIGH   										HAL_GPIO_WritePin(DAC8568_SCK_GPIO_Port, DAC8568_SCK_Pin, GPIO_PIN_SET)
#define DAC8568_SCK_LOW    										HAL_GPIO_WritePin(DAC8568_SCK_GPIO_Port, DAC8568_SCK_Pin, GPIO_PIN_RESET)

#define DAC8568_DIN_HIGH   										HAL_GPIO_WritePin(DAC8568_DOUT_GPIO_Port, DAC8568_DOUT_Pin, GPIO_PIN_SET)
#define DAC8568_DIN_LOW    										HAL_GPIO_WritePin(DAC8568_DOUT_GPIO_Port, DAC8568_DOUT_Pin, GPIO_PIN_RESET)

#define DAC8568_LDAC_HIGH  										HAL_GPIO_WritePin(DAC8568_LDAC_GPIO_Port, DAC8568_LDAC_Pin, GPIO_PIN_SET)
#define DAC8568_LDAC_LOW   										HAL_GPIO_WritePin(DAC8568_LDAC_GPIO_Port, DAC8568_LDAC_Pin, GPIO_PIN_RESET)

#define DAC8568_CLR_HIGH   										HAL_GPIO_WritePin(DAC8568_CLEAR_GPIO_Port, DAC8568_CLEAR_Pin, GPIO_PIN_SET)
