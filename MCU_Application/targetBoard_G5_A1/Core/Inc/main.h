...
#define ADC_HT_NTC_Pin GPIO_PIN_3
#define ADC_HT_NTC_GPIO_Port GPIOA
#define SPK_DAC_Pin GPIO_PIN_4
#define SPK_DAC_GPIO_Port GPIOA
#define ADC_LNTC_Pin GPIO_PIN_5
#define ADC_LNTC_GPIO_Port GPIOA
#define ADC_LPD_Pin GPIO_PIN_6
#define ADC_LPD_GPIO_Port GPIOA
#define ADC_FPD_Pin GPIO_PIN_7
#define ADC_FPD_GPIO_Port GPIOA
