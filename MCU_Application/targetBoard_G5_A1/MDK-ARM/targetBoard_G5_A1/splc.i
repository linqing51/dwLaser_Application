...
void sPlcInit(void){
	...
	if(deviceConfig.greenLedDc <= 0 || (deviceConfig.greenLedDc > 100)){
		...
		(((0x00000000U) == 0x00000000U) ? ((&htim3)->Instance ->CCR1 = (deviceConfig . greenLedDc)) : ((0x00000000U) == 0x00000004U) ? ((&htim3)->Instance ->CCR2 = (deviceConfig . greenLedDc)) : ((0x00000000U) == 0x00000008U) ? ((&htim3)->Instance ->CCR3 = (deviceConfig . greenLedDc)) : ((&htim3)->Instance ->CCR4 = (deviceConfig . greenLedDc)));;
	}
	...
	if(deviceConfig.blueLedDc <= 0 || (deviceConfig.blueLedDc > 100)){
		...
		(((0x00000008U) == 0x00000000U) ? ((&htim3)->Instance ->CCR1 = (deviceConfig . blueLedDc)) : ((0x00000008U) == 0x00000004U) ? ((&htim3)->Instance ->CCR2 = (deviceConfig . blueLedDc)) : ((0x00000008U) == 0x00000008U) ? ((&htim3)->Instance ->CCR3 = (deviceConfig . blueLedDc)) : ((&htim3)->Instance ->CCR4 = (deviceConfig . blueLedDc)));;
	}
}
