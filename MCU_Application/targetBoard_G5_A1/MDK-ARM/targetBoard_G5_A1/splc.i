...
#pragma pack(push, 4)
int16_t NVRAM0[(1463 + 1)];
int16_t NVRAM1[(1463 + 1)];
int16_t FDRAM0[(2047 - 0 + 1)], FDRAM1[(2047 - 0 + 1)];
uint32_t BootloadCrc, ApplicationCrc;
#pragma pack(pop)
 
uint16_t TimerCounter_10mS = 0;
uint16_t TimerCounter_100mS = 0;
uint16_t TimerCounter_200mS = 0;
uint16_t TimerCounter_500mS = 0;
uint16_t TimerCounter_1000mS = 0;
uint16_t TimerCounter_60000mS = 0;
...
void sPlcAssertCoilAddress(uint16_t adr){

	uint32_t maxCoilAdr = (1463 + 1) * 16 - 1;
	if(adr > (maxCoilAdr)){
		while(1);
	}
...
void sPlcAssertRegisterAddress(uint16_t adr){
...
void sPlcNvramLoad(void){
	uint32_t crc32_mr, crc32_dm;
	uint32_t crc32_eprom_mr, crc32_eprom_dm;
	memset((uint8_t*)NVRAM0, 0x0, ((1463 + 1) * 2));
	
	epromRead((0x0L), (uint8_t*)(NVRAM0 + 0), ((31 - 0 + 1) * 2));
	epromReadDword((7524L), &crc32_eprom_mr);
	crc32_mr = HAL_CRC_Calculate(&hcrc,(uint32_t *)(NVRAM0 + 0), ((31 - 0 + 1) / 2));
	
	
	epromRead((((0x0L) + 31 - 0) + 1), (uint8_t*)(NVRAM0 + 32), ((543 - 32 + 1) * 2));
	epromReadDword((7528L), &crc32_eprom_dm);
	crc32_dm = HAL_CRC_Calculate(&hcrc,(uint32_t *)(NVRAM0 + 32), ((543 - 32 + 1) / 2));
	
	memcpy((uint8_t*)NVRAM1, (uint8_t*)NVRAM0, ((1463 + 1) * 2));
	printf("%s,%d,%s:MR EPROM CRC:0x%08X,MR CALC CRC:0x%08X\n","..\\..\\sPlc\\sPlc.c", 67, __func__, crc32_eprom_mr, crc32_mr);
	printf("%s,%d,%s:DM EPROM CRC:0x%08X,DM CALC CRC:0x%08X\n","..\\..\\sPlc\\sPlc.c", 68, __func__, crc32_eprom_dm, crc32_dm);
	if((crc32_eprom_mr != crc32_mr) && (crc32_eprom_dm != crc32_dm)){
		printf("%s,%d,%s:load NVRAM crc fail...\n","..\\..\\sPlc\\sPlc.c", 70, __func__);
	}
	else{
		printf("%s,%d,%s:load NVRAM done...\n","..\\..\\sPlc\\sPlc.c", 73, __func__);
	}
}
void sPlcNvramSave(void){
	uint32_t crc32_mr, crc32_dm;
	
	epromWrite((0x0L), (uint8_t*)(NVRAM0 + 0), ((31 - 0 + 1) * 2));
	crc32_mr = HAL_CRC_Calculate(&hcrc,(uint32_t *)(NVRAM0 + 0), ((31 - 0 + 1) / 2));
	epromWriteDword((7524L), &crc32_mr);
	
	epromWrite((((0x0L) + 31 - 0) + 1), (uint8_t*)(NVRAM0 + 32), ((543 - 32 + 1) * 2));
	crc32_dm = HAL_CRC_Calculate(&hcrc,(uint32_t *)(NVRAM0 + 32), ((543 - 32 + 1) / 2));
	epromWriteDword((7528L), &crc32_dm);
	printf("%s,%d,%s:save NVRAM done...(MR CRC:0x%08X,DM CRC:0x%08X)\n","..\\..\\sPlc\\sPlc.c", 86, __func__, crc32_mr, crc32_dm);
}
void sPlcNvramUpdate(void){
	uint8_t *sp0, *sp1;
	...
	updateFlagMr = 0;
	sp0 = (uint8_t*)(NVRAM0 + 0);
	sp1 = (uint8_t*)(NVRAM1 + 0);
	for(i = 0;i < ((31 - 0 + 1) * 2);i ++){
		if(*sp0 != *sp1){
			epromWriteByte((i + (0x0L)), sp0);
			updateFlagMr |= 0xFF;
		}
		sp0 ++;
		sp1 ++;
	...
	updateFlagDm = 0;
	sp0 = (uint8_t*)(NVRAM0 + 32);
	sp1 = (uint8_t*)(NVRAM1 + 32);
	for(i = 0;i < ((543 - 32 + 1) * 2);i ++){
		if(*sp0 != *sp1){
			epromWriteByte((i + (((0x0L) + 31 - 0) + 1)), sp0);
			updateFlagDm |= 0xFF;
		}
		sp0 ++;
		sp1 ++;
	...
	memcpy((uint8_t*)(NVRAM1), (uint8_t*)(NVRAM0), ((1463 + 1) * 2));
	if(updateFlagMr){
		printf("%s,%d,%s:update MR NVRAM done...(MR CRC:0x%08X)\n","..\\..\\sPlc\\sPlc.c", 127, __func__, crc32_mr);
	}
	if(updateFlagDm){
		printf("%s,%d,%s:update DM NVRAM done...(DM CRC:0x%08X)\n","..\\..\\sPlc\\sPlc.c", 130, __func__, crc32_dm);
	}
}
void sPlcNvramClear(void){
	sPlcIsrDisable();
	clearEprom(CLEAR_EPROM_NVRAM);
	memset((uint8_t*)NVRAM0, 0x0, ((1463 + 1) * 2));
	memset((uint8_t*)NVRAM1, 0x0, ((1463 + 1) * 2));
	sPlcIsrEnable();
	printf("%s,%d,%s:clear NVRAM done...\n","..\\..\\sPlc\\sPlc.c", 139, __func__);
}
void sPlcFdramLoad(void){
	HAL_StatusTypeDef ref;
	sPlcIsrDisable();
	ref = epromRead((((((0x0L) + 31 - 0) + 1) + 543 - 32) + 1), (uint8_t*)FDRAM0, ((2047 - 0 + 1) * 2));
	sPlcIsrEnable();
	if(ref != HAL_OK){
		printf("%s,%d,%s:load FD NVRAM crc fail!!!\n","..\\..\\sPlc\\sPlc.c", 147, __func__);
	}
	else{
		printf("%s,%d,%s:load FD NVRAM done...\n","..\\..\\sPlc\\sPlc.c", 150, __func__);
	}
}
void sPlcFdramSave(void){
	HAL_StatusTypeDef ref;
	sPlcIsrDisable();
	ref = epromWrite((((((0x0L) + 31 - 0) + 1) + 543 - 32) + 1), (uint8_t*)FDRAM0, ((2047 - 0 + 1) * 2));
	if(ref != HAL_OK){
		printf("%s,%d,%s:save FD NVRAM fail...\n","..\\..\\sPlc\\sPlc.c", 158, __func__);
	}
	else{
		printf("%s,%d,%s:save FD NVRAM done...\n","..\\..\\sPlc\\sPlc.c", 161, __func__);
	}
	sPlcIsrEnable();
}
void sPlcFdramClear(void){
	sPlcIsrDisable();
	clearEprom(CLEAR_EPROM_FDRAM);
	memset(FDRAM0, 0x0, ((2047 - 0 + 1) * 2));
	printf("%s,%d,%s:clear FD NVRAM done...\n","..\\..\\sPlc\\sPlc.c", 169, __func__);
	sPlcIsrEnable();
}
void sPlcDeviceConfigClear(void){
	sPlcIsrDisable();
	clearEprom(CLEAR_EPROM_DEVICE_CONFIG);
	printf("%s,%d,%s:clear FD NVRAM done...\n","..\\..\\sPlc\\sPlc.c", 175, __func__);
	sPlcIsrEnable();
}
void sPlcDeviceLogClear(void){
	sPlcIsrDisable();
	clearEprom(CLEAR_EPROM_LOG_INFO);
	printf("%s,%d,%s:clear device log done...\n","..\\..\\sPlc\\sPlc.c", 181, __func__);
	sPlcIsrEnable();
}

void sPlcSpwmLoop(void){
	if(LDP((1384 * 16 + 2))){
		
		if(LD((1384 * 16 + 49))){
			NVRAM0[(1320 + 44)] = 0x7fff;
			NVRAM0[(1320 + 43)] = 0;
			RRES((1384 * 16 + 49));
			RRES((1384 * 16 + 48));
		}
		if(NVRAM0[(1320 + 44)] >= NVRAM0[(1320 + 43)]){
			NVRAM0[(1320 + 44)] = 0;
			NVRAM0[(1320 + 41)] = NVRAM0[(1320 + 40)];
			NVRAM0[(1320 + 43)] = NVRAM0[(1320 + 42)];
			SSET((1384 * 16 + 48));
		}
		else if(NVRAM0[(1320 + 44)] == NVRAM0[(1320 + 41)]){
			NVRAM0[(1320 + 44)] = NVRAM0[(1320 + 44)] + 1;
			RRES((1384 * 16 + 48));
		}
		else{
			NVRAM0[(1320 + 44)] = NVRAM0[(1320 + 44)] + 1;
		...
		if(LD((1384 * 16 + 51))){
			NVRAM0[(1320 + 49)] = 0x7fff;
			NVRAM0[(1320 + 48)] = 0; 
			RRES((1384 * 16 + 51));
			RRES((1384 * 16 + 50));
		}
		if(NVRAM0[(1320 + 49)] >= NVRAM0[(1320 + 48)]){
			NVRAM0[(1320 + 49)] = 0;
			NVRAM0[(1320 + 46)] = NVRAM0[(1320 + 45)];
			NVRAM0[(1320 + 48)] = NVRAM0[(1320 + 47)];
			SSET((1384 * 16 + 50));
		}
		else if(NVRAM0[(1320 + 49)] == NVRAM0[(1320 + 46)]){
			NVRAM0[(1320 + 49)] = NVRAM0[(1320 + 49)] + 1;
			RRES((1384 * 16 + 50));
		}
		...
		if(LD((1384 * 16 + 53))){
			NVRAM0[(1320 + 54)] = 0x7fff;
			NVRAM0[(1320 + 48)] = 0;
			RRES((1384 * 16 + 53));
			RRES((1384 * 16 + 52));
		}
		if(NVRAM0[(1320 + 54)] >= NVRAM0[(1320 + 53)]){
			NVRAM0[(1320 + 54)] = 0;
			NVRAM0[(1320 + 51)] = NVRAM0[(1320 + 50)];
			NVRAM0[(1320 + 53)] = NVRAM0[(1320 + 52)];
			SSET((1384 * 16 + 52));
		}
		else if(NVRAM0[(1320 + 54)] == NVRAM0[(1320 + 51)]){
			NVRAM0[(1320 + 54)] = NVRAM0[(1320 + 54)] + 1;
			RRES((1384 * 16 + 52));
		}
		else{
			NVRAM0[(1320 + 54)] = NVRAM0[(1320 + 54)] + 1;
		...
		if(LD((1384 * 16 + 55))){
			NVRAM0[(1320 + 59)] = 0x7fff;
			NVRAM0[(1320 + 58)] = 0;
			RRES((1384 * 16 + 55));
			RRES((1384 * 16 + 54));
		}
		if(NVRAM0[(1320 + 59)] >= NVRAM0[(1320 + 58)]){
			NVRAM0[(1320 + 59)] = 0;
			NVRAM0[(1320 + 56)] = NVRAM0[(1320 + 55)];
			NVRAM0[(1320 + 58)] = NVRAM0[(1320 + 57)];
			SSET((1384 * 16 + 54));
		}
		else if(NVRAM0[(1320 + 59)] == NVRAM0[(1320 + 56)]){
			NVRAM0[(1320 + 59)] = NVRAM0[(1320 + 59)] + 1;
			RRES((1384 * 16 + 54));
		}
		else{
			NVRAM0[(1320 + 59)] = NVRAM0[(1320 + 59)] + 1;
...
void sPlcInit(void){
	...
	printf("%s,%d,%s:bootload crc:0x%08X\n","..\\..\\sPlc\\sPlc.c", 284, __func__, BootloadCrc);
	printf("%s,%d,%s:app crc:0x%08X\n","..\\..\\sPlc\\sPlc.c", 285, __func__, ApplicationCrc);
	SSET((1384 * 16 + 0));
	SSET((1384 * 16 + 1));
	sPlcInputInit();
	sPlcOutputInit();	
	...
	sPlcTimerInit();
	sPlcSpeakerInit();
	HAL_TIM_PWM_Stop(&htim3, 0x00000004U);
	HAL_TIM_PWM_Stop(&htim3, 0x00000008U);	
	HAL_TIM_PWM_Stop(&htim3, 0x00000000U);
	RRES((1312 * 16 + 3));
	if(deviceConfig.greenLedDc <= 0 || (deviceConfig.greenLedDc > 100)){
		(((0x00000008U) == 0x00000000U) ? ((&htim3)->Instance ->CCR1 = (10)) : ((0x00000008U) == 0x00000004U) ? ((&htim3)->Instance ->CCR2 = (10)) : ((0x00000008U) == 0x00000008U) ? ((&htim3)->Instance ->CCR3 = (10)) : ((&htim3)->Instance ->CCR4 = (10)));;
	}
	else{
		(((0x00000008U) == 0x00000000U) ? ((&htim3)->Instance ->CCR1 = (deviceConfig . greenLedDc)) : ((0x00000008U) == 0x00000004U) ? ((&htim3)->Instance ->CCR2 = (deviceConfig . greenLedDc)) : ((0x00000008U) == 0x00000008U) ? ((&htim3)->Instance ->CCR3 = (deviceConfig . greenLedDc)) : ((&htim3)->Instance ->CCR4 = (deviceConfig . greenLedDc)));;
	}
	if(deviceConfig.redLedDc <= 0 || (deviceConfig.redLedDc > 100)){
		(((0x00000004U) == 0x00000000U) ? ((&htim3)->Instance ->CCR1 = (10)) : ((0x00000004U) == 0x00000004U) ? ((&htim3)->Instance ->CCR2 = (10)) : ((0x00000004U) == 0x00000008U) ? ((&htim3)->Instance ->CCR3 = (10)) : ((&htim3)->Instance ->CCR4 = (10)));;
	}
	else{
		(((0x00000004U) == 0x00000000U) ? ((&htim3)->Instance ->CCR1 = (deviceConfig . redLedDc)) : ((0x00000004U) == 0x00000004U) ? ((&htim3)->Instance ->CCR2 = (deviceConfig . redLedDc)) : ((0x00000004U) == 0x00000008U) ? ((&htim3)->Instance ->CCR3 = (deviceConfig . redLedDc)) : ((&htim3)->Instance ->CCR4 = (deviceConfig . redLedDc)));;
	}
	if(deviceConfig.blueLedDc <= 0 || (deviceConfig.blueLedDc > 100)){
		(((0x00000000U) == 0x00000000U) ? ((&htim3)->Instance ->CCR1 = (10)) : ((0x00000000U) == 0x00000004U) ? ((&htim3)->Instance ->CCR2 = (10)) : ((0x00000000U) == 0x00000008U) ? ((&htim3)->Instance ->CCR3 = (10)) : ((&htim3)->Instance ->CCR4 = (10)));;
	}
	else{
		(((0x00000000U) == 0x00000000U) ? ((&htim3)->Instance ->CCR1 = (deviceConfig . blueLedDc)) : ((0x00000000U) == 0x00000004U) ? ((&htim3)->Instance ->CCR2 = (deviceConfig . blueLedDc)) : ((0x00000000U) == 0x00000008U) ? ((&htim3)->Instance ->CCR3 = (deviceConfig . blueLedDc)) : ((&htim3)->Instance ->CCR4 = (deviceConfig . blueLedDc)));;
	}
}
