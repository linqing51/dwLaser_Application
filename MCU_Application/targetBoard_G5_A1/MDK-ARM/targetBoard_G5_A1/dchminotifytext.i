#line 1 "..\\..\\MainApp\\dcHmiNotifyText.c"
#line 1 "..\\..\\MainApp\\dcHmiNotifyText.h"
...
#line 5 "..\\..\\MainApp\\dcHmiNotifyText.h"
 
void NotifyText(uint16_t screen_id, uint16_t control_id, uint8_t *str);


#line 2 "..\\..\\MainApp\\dcHmiNotifyText.c"
	...
	switch(screen_id){
		case 14:{
			switch(control_id){
				case 1:{
					tmp = NVRAM0[(576 + 88)];
					if(strlen((const char*)str) <= (((576 + 55) - (576 + 0) -1) * 2)){
						strcpy((char*)&FDRAM1[tmp * 64 + (0 + 0)], (char*)str);
						SetTextValue(11, (20 + tmp), str);
