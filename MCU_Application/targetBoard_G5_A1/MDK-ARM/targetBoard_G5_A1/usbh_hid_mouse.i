#line 1 "../Middlewares/ST/STM32_USB_Host_Library/Class/HID/Src/usbh_hid_mouse.c"
...
#line 103 "../Middlewares/ST/STM32_USB_Host_Library/Class/HID/Inc/usbh_hid_mouse.h"
...
#line 28 "../Middlewares/ST/STM32_USB_Host_Library/Class/HID/Src/usbh_hid_mouse.c"
...
#line 29 "../Middlewares/ST/STM32_USB_Host_Library/Class/HID/Src/usbh_hid_mouse.c"
...
uint8_t                  mouse_report_data[0x8U];
uint8_t                  mouse_rx_report_buf[0x8U];
...
USBH_StatusTypeDef USBH_HID_MouseInit(USBH_HandleTypeDef *phost)
{
  ...
  if ((10U * sizeof(mouse_report_data)) > sizeof(phost->device.Data))
  {
    return USBH_FAIL;
  }
  else
  {
    USBH_HID_FifoInit(&HID_Handle->fifo, phost->device.Data, (uint16_t)(10U * sizeof(mouse_report_data)));
  }
