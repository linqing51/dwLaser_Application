#line 1 "../Middlewares/ST/STM32_USB_Host_Library/Class/MTP/Src/usbh_mtp_ptp.c"
...
#line 30 "../Middlewares/ST/STM32_USB_Host_Library/Class/MTP/Src/usbh_mtp_ptp.c"
...
#line 31 "../Middlewares/ST/STM32_USB_Host_Library/Class/MTP/Src/usbh_mtp_ptp.c"
...
USBH_StatusTypeDef USBH_PTP_Process(USBH_HandleTypeDef *phost)
{
  ...
  switch (MTP_Handle->ptp.state)
  {
    ...
    case PTP_OP_REQUEST_WAIT_STATE:
      ...
      {
        if (MTP_Handle->ptp.flags == 0x0000U)
        {
          MTP_Handle->ptp.state = PTP_RESPONSE_STATE;
        }
        else  if (MTP_Handle->ptp.flags == 0x0001U)
        {
          MTP_Handle->ptp.state = PTP_DATA_OUT_PHASE_STATE;
        }
        else  if (MTP_Handle->ptp.flags == 0x0002U)
        {
    ...
    case PTP_DATA_OUT_PHASE_WAIT_STATE:
      ...
      if (URB_Status == USBH_URB_DONE)
      {
        ...
        if (MTP_Handle->ptp.data_length > MTP_Handle->DataOutEpSize)
        {
          ...
          if (MTP_Handle->ptp.data_packet >= (1024U - ((2U * sizeof(uint32_t)) + (2U * sizeof(uint16_t)))))
          {
...
USBH_StatusTypeDef USBH_PTP_SendRequest(USBH_HandleTypeDef *phost, PTP_ContainerTypedef  *req)
{
  ...
  (void)memset(&(MTP_Handle->ptp.op_container), 0, sizeof(PTP_OpContainerTypedef));

   
  MTP_Handle->ptp.op_container.length = (((2U * sizeof(uint32_t)) + (2U * sizeof(uint16_t))) + (5U * sizeof(uint32_t))) - ((sizeof(uint32_t) * (5U - (uint32_t)req->Nparam)));
  MTP_Handle->ptp.op_container.type = 0x0001U;
  ...
  switch (MTP_Handle->ptp.data_container.code)
  {
    ...
    case 0x1009U:
      ...
      if (MTP_Handle->ptp.iteration == 0U)
      {
        ...
        (void)memcpy(MTP_Handle->ptp.object_ptr, MTP_Handle->ptp.data_container.payload.data,
                          (1024U - ((2U * sizeof(uint32_t)) + (2U * sizeof(uint16_t)))));

         
        MTP_Handle->ptp.data_ptr = (MTP_Handle->ptp.object_ptr + (1024U - ((2U * sizeof(uint32_t)) + (2U * sizeof(uint16_t)))));
      }
      break;
...
static void PTP_DecodeDeviceInfo(USBH_HandleTypeDef *phost, PTP_DeviceInfoTypedef *dev_info)
{
  ...
  do { printf("DEBUG : "); printf(" MTP device info size exceeds internal buffer size.               only available data are decoded."); printf("\n"); } while (0);


  if (MTP_Handle->ptp.iteration == 0U)
  {
    dev_info->StandardVersion = (((uint16_t)(&data[0U])[0]) | ((uint16_t)(((uint32_t)(&data[0U])[1]) << 8)));
    dev_info->VendorExtensionID = (((uint32_t)(&data[2U])[0]) | (((uint32_t)(&data[2U])[1]) << 8) | (((uint32_t)(&data[2U])[2]) << 16) | (((uint32_t)(&data[2U])[3]) << 24));
    dev_info->VendorExtensionVersion = (((uint16_t)(&data[6U])[0]) | ((uint16_t)(((uint32_t)(&data[6U])[1]) << 8)));
    PTP_GetString(dev_info->VendorExtensionDesc, &data[8U], &len);

    totallen = (uint32_t)(len * 2U) + 1U;
    dev_info->FunctionalMode = (((uint16_t)(&data[8U + totallen])[0]) | ((uint16_t)(((uint32_t)(&data[8U + totallen])[1]) << 8)));
    ...
    PTP_GetString(dev_info->Manufacturer, &data[10U + totallen], &len);

    totallen += (uint32_t)(len * 2U) + 1U;
    PTP_GetString(dev_info->Model, &data[10U + totallen], &len);

    totallen += (uint32_t)(len * 2U) + 1U;
    PTP_GetString(dev_info->DeviceVersion, &data[10U + totallen], &len);

    totallen += (uint32_t)(len * 2U) + 1U;
    PTP_GetString(dev_info->SerialNumber, &data[10U + totallen], &len);
  }
}
...
static void PTP_GetStorageInfo(USBH_HandleTypeDef *phost, uint32_t storage_id, PTP_StorageInfoTypedef *stor_info)
{
  ...
  stor_info->StorageType = (((uint16_t)(&data[0U])[0]) | ((uint16_t)(((uint32_t)(&data[0U])[1]) << 8)));
  stor_info->FilesystemType = (((uint16_t)(&data[2U])[0]) | ((uint16_t)(((uint32_t)(&data[2U])[1]) << 8)));
  stor_info->AccessCapability = (((uint16_t)(&data[4U])[0]) | ((uint16_t)(((uint32_t)(&data[4U])[1]) << 8)));
  stor_info->MaxCapability = (((uint64_t)(&data[6U])[0]) | (((uint64_t)(&data[6U])[1]) << 8) | (((uint64_t)(&data[6U])[2]) << 16) | (((uint64_t)(&data[6U])[3]) << 24) | (((uint64_t)(&data[6U])[4]) << 32) | (((uint64_t)(&data[6U])[5]) << 40) | (((uint64_t)(&data[6U])[6]) << 48) | (((uint64_t)(&data[6U])[7]) << 56));
  stor_info->FreeSpaceInBytes = (((uint64_t)(&data[14U])[0]) | (((uint64_t)(&data[14U])[1]) << 8) | (((uint64_t)(&data[14U])[2]) << 16) | (((uint64_t)(&data[14U])[3]) << 24) | (((uint64_t)(&data[14U])[4]) << 32) | (((uint64_t)(&data[14U])[5]) << 40) | (((uint64_t)(&data[14U])[6]) << 48) | (((uint64_t)(&data[14U])[7]) << 56));
  stor_info->FreeSpaceInImages = (((uint32_t)(&data[22U])[0]) | (((uint32_t)(&data[22U])[1]) << 8) | (((uint32_t)(&data[22U])[2]) << 16) | (((uint32_t)(&data[22U])[3]) << 24));

  PTP_GetString(stor_info->StorageDescription, &data[26U], &len);
  PTP_GetString(stor_info->VolumeLabel, &data[26U + (len * 2U) + 1U], &len);
}
...
static void PTP_GetObjectInfo(USBH_HandleTypeDef *phost, PTP_ObjectInfoTypedef *object_info)
{
  ...
  object_info->StorageID = (((uint32_t)(&data[0U])[0]) | (((uint32_t)(&data[0U])[1]) << 8) | (((uint32_t)(&data[0U])[2]) << 16) | (((uint32_t)(&data[0U])[3]) << 24));
  object_info->ObjectFormat = (((uint16_t)(&data[4U])[0]) | ((uint16_t)(((uint32_t)(&data[4U])[1]) << 8)));
  object_info->ProtectionStatus = (((uint16_t)(&data[6U])[0]) | ((uint16_t)(((uint32_t)(&data[6U])[1]) << 8)));
  object_info->ObjectCompressedSize = (((uint64_t)(&data[8U])[0]) | (((uint64_t)(&data[8U])[1]) << 8) | (((uint64_t)(&data[8U])[2]) << 16) | (((uint64_t)(&data[8U])[3]) << 24) | (((uint64_t)(&data[8U])[4]) << 32) | (((uint64_t)(&data[8U])[5]) << 40) | (((uint64_t)(&data[8U])[6]) << 48) | (((uint64_t)(&data[8U])[7]) << 56));

   
  if ((data[52U] == 0U) && (data[52U + 4U] != 0U))
  {
    data += 4;
  }
  object_info->ThumbFormat = (((uint16_t)(&data[12U])[0]) | ((uint16_t)(((uint32_t)(&data[12U])[1]) << 8)));
  object_info->ThumbCompressedSize = (((uint32_t)(&data[14U])[0]) | (((uint32_t)(&data[14U])[1]) << 8) | (((uint32_t)(&data[14U])[2]) << 16) | (((uint32_t)(&data[14U])[3]) << 24));
  object_info->ThumbPixWidth = (((uint32_t)(&data[18U])[0]) | (((uint32_t)(&data[18U])[1]) << 8) | (((uint32_t)(&data[18U])[2]) << 16) | (((uint32_t)(&data[18U])[3]) << 24));
  object_info->ThumbPixHeight = (((uint32_t)(&data[22U])[0]) | (((uint32_t)(&data[22U])[1]) << 8) | (((uint32_t)(&data[22U])[2]) << 16) | (((uint32_t)(&data[22U])[3]) << 24));
  object_info->ImagePixWidth = (((uint32_t)(&data[26U])[0]) | (((uint32_t)(&data[26U])[1]) << 8) | (((uint32_t)(&data[26U])[2]) << 16) | (((uint32_t)(&data[26U])[3]) << 24));
  object_info->ImagePixHeight = (((uint32_t)(&data[30U])[0]) | (((uint32_t)(&data[30U])[1]) << 8) | (((uint32_t)(&data[30U])[2]) << 16) | (((uint32_t)(&data[30U])[3]) << 24));
  object_info->ImageBitDepth = (((uint32_t)(&data[34U])[0]) | (((uint32_t)(&data[34U])[1]) << 8) | (((uint32_t)(&data[34U])[2]) << 16) | (((uint32_t)(&data[34U])[3]) << 24));
  object_info->ParentObject = (((uint32_t)(&data[38U])[0]) | (((uint32_t)(&data[38U])[1]) << 8) | (((uint32_t)(&data[38U])[2]) << 16) | (((uint32_t)(&data[38U])[3]) << 24));
  object_info->AssociationType = (((uint16_t)(&data[42U])[0]) | ((uint16_t)(((uint32_t)(&data[42U])[1]) << 8)));
  object_info->AssociationDesc = (((uint32_t)(&data[44U])[0]) | (((uint32_t)(&data[44U])[1]) << 8) | (((uint32_t)(&data[44U])[2]) << 16) | (((uint32_t)(&data[44U])[3]) << 24));
  object_info->SequenceNumber = (((uint32_t)(&data[48U])[0]) | (((uint32_t)(&data[48U])[1]) << 8) | (((uint32_t)(&data[48U])[2]) << 16) | (((uint32_t)(&data[48U])[3]) << 24));
  PTP_GetString(object_info->Filename, &data[52U], &filenamelen);
}
...
static void PTP_GetObjectPropDesc(USBH_HandleTypeDef *phost, PTP_ObjectPropDescTypeDef *opd, uint32_t opdlen)
{
  ...
  opd->ObjectPropertyCode = (((uint16_t)(&data[0U])[0]) | ((uint16_t)(((uint32_t)(&data[0U])[1]) << 8)));
  opd->DataType = (((uint16_t)(&data[2U])[0]) | ((uint16_t)(((uint32_t)(&data[2U])[1]) << 8)));
  opd->GetSet = *(uint8_t *)(&data[4U]);

  offset = 5U;
  PTP_GetDevicePropValue(phost, &offset, opdlen, &opd->FactoryDefaultValue, opd->DataType);

  opd->GroupCode = (((uint32_t)(&data[offset])[0]) | (((uint32_t)(&data[offset])[1]) << 8) | (((uint32_t)(&data[offset])[2]) << 16) | (((uint32_t)(&data[offset])[3]) << 24));
  ...
  switch (opd->FormFlag)
  {
    ...
    case 0x02U:
      ...
      opd->FORM.Enum.NumberOfValues = (((uint16_t)(&data[offset])[0]) | ((uint16_t)(((uint32_t)(&data[offset])[1]) << 8)));
  ...
  switch (datatype)
  {
    ...
    case 0x0003U:
      ...
      *offset += 2U;
      break;
    case 0x0004U:
      value->u16 = (((uint16_t)(&(data[*offset]))[0]) | ((uint16_t)(((uint32_t)(&(data[*offset]))[1]) << 8)));
      *offset += 2U;
      break;
    case 0x0005U:
      ...
      *offset += 4U;
      break;
    case 0x0006U:
      value->u32 = (((uint32_t)(&(data[*offset]))[0]) | (((uint32_t)(&(data[*offset]))[1]) << 8) | (((uint32_t)(&(data[*offset]))[2]) << 16) | (((uint32_t)(&(data[*offset]))[3]) << 24));
      *offset += 4U;
      break;
    case 0x0007U:
      ...
      *offset += 8U;
      break;
    case 0x0008U:
      value->u64 = (((uint64_t)(&(data[*offset]))[0]) | (((uint64_t)(&(data[*offset]))[1]) << 8) | (((uint64_t)(&(data[*offset]))[2]) << 16) | (((uint64_t)(&(data[*offset]))[3]) << 24) | (((uint64_t)(&(data[*offset]))[4]) << 32) | (((uint64_t)(&(data[*offset]))[5]) << 40) | (((uint64_t)(&(data[*offset]))[6]) << 48) | (((uint64_t)(&(data[*offset]))[7]) << 56));
      *offset += 8U;
      break;
                                      ...
                                      uint32_t len)
{
  ...
  prop_count = (((uint32_t)(data)[0]) | (((uint32_t)(data)[1]) << 8) | (((uint32_t)(data)[2]) << 16) | (((uint32_t)(data)[3]) << 24));
  ...
  for (i = 0U; i < prop_count; i++)
  {
    ...
    props[i].ObjectHandle = (((uint32_t)(data)[0]) | (((uint32_t)(data)[1]) << 8) | (((uint32_t)(data)[2]) << 16) | (((uint32_t)(data)[3]) << 24));
    data += sizeof(uint32_t);
    len -= sizeof(uint32_t);

    props[i].property = (((uint16_t)(data)[0]) | ((uint16_t)(((uint32_t)(data)[1]) << 8)));
    data += sizeof(uint16_t);
    len -= sizeof(uint16_t);

    props[i].datatype = (((uint16_t)(data)[0]) | ((uint16_t)(((uint32_t)(data)[1]) << 8)));
    data += sizeof(uint16_t);
    len -= sizeof(uint16_t);
...
static uint32_t PTP_GetArray16(uint16_t *array, uint8_t *data, uint32_t offset)
{
  ...
  size = (((uint32_t)(&data[offset])[0]) | (((uint32_t)(&data[offset])[1]) << 8) | (((uint32_t)(&data[offset])[2]) << 16) | (((uint32_t)(&data[offset])[3]) << 24));
  while (size > idx)
  {
...
static uint32_t PTP_GetArray32(uint32_t *array, uint8_t *data, uint32_t offset)
{
  ...
  while (size > idx)
  {
    array[idx] = (((uint32_t)(&data[offset + (sizeof(uint32_t) * (idx + 1U))])[0]) | (((uint32_t)(&data[offset + (sizeof(uint32_t) * (idx + 1U))])[1]) << 8) | (((uint32_t)(&data[offset + (sizeof(uint32_t) * (idx + 1U))])[2]) << 16) | (((uint32_t)(&data[offset + (sizeof(uint32_t) * (idx + 1U))])[3]) << 24));
    idx++;
  }
  return size;
}
...
USBH_StatusTypeDef USBH_PTP_OpenSession(USBH_HandleTypeDef *phost, uint32_t session)
{
  ...
  switch (MTP_Handle->ptp.req_state)
  {
    case PTP_REQ_SEND:
      ...
      MTP_Handle->ptp.flags = 0x0000U;

       
      ptp_container.Code = 0x1002U;
                                              ...
                                              PTP_DevicePropDescTypdef *devicepropertydesc)
{
  ...
  switch (MTP_Handle->ptp.req_state)
  {
    ...
    case PTP_REQ_WAIT:
      ...
      if (status == USBH_OK)
      {
        devicepropertydesc->DevicePropertyCode = (((uint16_t)(&data[0U])[0]) | ((uint16_t)(((uint32_t)(&data[0U])[1]) << 8)));
        devicepropertydesc->DataType = (((uint16_t)(&data[2U])[0]) | ((uint16_t)(((uint32_t)(&data[2U])[1]) << 8)));
        devicepropertydesc->GetSet = *(uint8_t *)(&data[4U]);
        devicepropertydesc->FormFlag = 0x00U;
      }
      break;
    ...
    case PTP_REQ_WAIT:
      ...
      if (status == USBH_OK)
      {
        ...
        if (MTP_Handle->ptp.iteration == 0U)
        {
          ...
          (void)memcpy(MTP_Handle->ptp.object_ptr,
                            MTP_Handle->ptp.data_container.payload.data,
                            (1024U - ((2U * sizeof(uint32_t)) + (2U * sizeof(uint16_t)))));
        }
      }
                                              ...
                                              uint32_t *nrofprops)
{
  ...
  switch (MTP_Handle->ptp.req_state)
  {
    case PTP_REQ_SEND:
      ...
      (void)memcpy(MTP_Handle->ptp.data_container.payload.data,
                        MTP_Handle->ptp.object_ptr, (1024U - ((2U * sizeof(uint32_t)) + (2U * sizeof(uint16_t)))));

       
      ptp_container.Code = 0x9805U;
      ptp_container.SessionID = MTP_Handle->ptp.session_id;
      ptp_container.Transaction_ID = MTP_Handle->ptp.transaction_id++;
      ptp_container.Param1 = handle;
