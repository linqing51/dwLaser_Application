...
#line 125 "../Middlewares/ST/STM32_USB_Host_Library/Core/Inc/usbh_ctlreq.h"
...
#line 21 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
...
USBH_StatusTypeDef USBH_Get_DevDesc(USBH_HandleTypeDef *phost, uint16_t length)
{
  ...
  {
    do { printf("ERROR: "); printf("Control error: Get Device Descriptor failed, data buffer size issue"); printf("\n"); } while (0);
    return USBH_NOT_SUPPORTED;
  }

  status = USBH_GetDescriptor(phost,
                              0x00U | 0x00U,
                              ((0x01U << 8) & 0xFF00U), phost->device.Data, length);
...
USBH_StatusTypeDef USBH_Get_CfgDesc(USBH_HandleTypeDef *phost, uint16_t length)
{
  ...
  {
    do { printf("ERROR: "); printf("Control error: Get configuration Descriptor failed, data buffer size issue"); printf("\n"); } while (0);
    return USBH_NOT_SUPPORTED;
  }

  status = USBH_GetDescriptor(phost, (0x00U | 0x00U),
                              ((0x02U << 8) & 0xFF00U), pData, length);
...
USBH_StatusTypeDef USBH_Get_StringDesc(USBH_HandleTypeDef *phost, uint8_t string_index, uint8_t *buff, uint16_t length)
{
  ...
  if ((length > sizeof(phost->device.Data)) || (buff == 0))
  {
    do { printf("ERROR: "); printf("Control error: Get String Descriptor failed, data buffer size issue"); printf("\n"); } while (0);
    return USBH_NOT_SUPPORTED;
  }
...
static USBH_StatusTypeDef USBH_ParseDevDesc(USBH_HandleTypeDef *phost, uint8_t *buf, uint16_t length)
{
  ...
  dev_desc->bcdUSB             = (((uint16_t)(buf + 2U)[0]) | ((uint16_t)(((uint32_t)(buf + 2U)[1]) << 8)));
  ...
  if (length > 8U)
  {
    ...
    dev_desc->idVendor           = (((uint16_t)(buf + 8U)[0]) | ((uint16_t)(((uint32_t)(buf + 8U)[1]) << 8)));
    dev_desc->idProduct          = (((uint16_t)(buf + 10U)[0]) | ((uint16_t)(((uint32_t)(buf + 10U)[1]) << 8)));
    dev_desc->bcdDevice          = (((uint16_t)(buf + 12U)[0]) | ((uint16_t)(((uint32_t)(buf + 12U)[1]) << 8)));
...
static USBH_StatusTypeDef USBH_ParseCfgDesc(USBH_HandleTypeDef *phost, uint8_t *buf, uint16_t length)
{
  ...
  cfg_desc->wTotalLength        = (((((uint16_t) (((uint16_t)(buf + 2U)[0]) | ((uint16_t)(((uint32_t)(buf + 2U)[1]) << 8))))) < (((uint16_t)256U))) ? (((uint16_t) (((uint16_t)(buf + 2U)[0]) | ((uint16_t)(((uint32_t)(buf + 2U)[1]) << 8))))) : (((uint16_t)256U)));
  ...
  if (length > 0x09U)
  {
    ...
    while ((if_ix < 10U) && (ptr < cfg_desc->wTotalLength))
    {
      ...
      if (pdesc->bDescriptorType == 0x04U)
      {
        ...
        while ((ep_ix < 5U) && (ep_ix < pif->bNumEndpoints) && (ptr < cfg_desc->wTotalLength))
        {
          pdesc = USBH_GetNextDesc((uint8_t *)(void *)pdesc, &ptr);
    ...
    if (if_ix < (((cfg_desc->bNumInterfaces) < ((uint8_t)10U)) ? (cfg_desc->bNumInterfaces) : ((uint8_t)10U)))
    {
      return USBH_NOT_SUPPORTED;
    }
  }
...
static USBH_StatusTypeDef USBH_ParseEPDesc(USBH_HandleTypeDef *phost, USBH_EpDescTypeDef *ep_descriptor, uint8_t *buf)
{
  ...
  ep_descriptor->wMaxPacketSize   = (((uint16_t)(buf + 4U)[0]) | ((uint16_t)(((uint32_t)(buf + 4U)[1]) << 8)));
  ep_descriptor->bInterval        = *(uint8_t *)(buf + 6U);

   
  if ((ep_descriptor->wMaxPacketSize == 0x00U) ||
      (ep_descriptor->wMaxPacketSize > 0x400U) ||
      (ep_descriptor->wMaxPacketSize > 1024U))
  {
    status = USBH_NOT_SUPPORTED;
  }
  ...
  if (phost->device.speed == (uint8_t)USBH_SPEED_HIGH)
  {
    if ((ep_descriptor->bmAttributes & 3U) == 2U)
    {
    ...
    else if ((ep_descriptor->bmAttributes & 3U) == 0U)
    {
    ...
    else if (((ep_descriptor->bmAttributes & 3U) == 1U) ||
        ((ep_descriptor->bmAttributes & 3U) == 3U))
    {
  ...
  {
    if (((ep_descriptor->bmAttributes & 3U) == 2U) ||
        ((ep_descriptor->bmAttributes & 3U) == 0U))
    {
      if (ep_descriptor->wMaxPacketSize > 64U)
      {
        status = USBH_NOT_SUPPORTED;
    ...
    else if ((ep_descriptor->bmAttributes & 3U) == 3U)
    {
  ...
  {
    if ((ep_descriptor->bmAttributes & 3U) == 0U)
    {
...
#line 920 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
    ...
    case CTRL_STATUS_IN:
      ...
      (void)USBH_CtlReceiveData(phost, 0, 0U, phost->Control.pipe_in);
...
#line 1045 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
    ...
    case CTRL_STATUS_OUT:
      (void)USBH_CtlSendData(phost, 0, 0U, phost->Control.pipe_out, 1U);
