...
#line 44 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc.c"
#line 45 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc.c"
#line 46 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc.c"
...
static USBH_StatusTypeDef USBH_MSC_InterfaceInit(USBH_HandleTypeDef *phost)
{
  ...
  (void)memset(MSC_Handle, 0, sizeof(MSC_HandleTypeDef));
        ...
        switch (MSC_Handle->unit[MSC_Handle->current_lun].state)
        {
          ...
          case MSC_READ_CAPACITY10:
            ...
            if (scsi_status == USBH_OK)
            {
              ...
              {
                do { printf("MSC Device capacity : %u Bytes", (unsigned int)(MSC_Handle ->unit[MSC_Handle ->current_lun]. capacity . block_nbr * MSC_Handle ->unit[MSC_Handle ->current_lun]. capacity . block_size)); printf("\n"); } while (0);


                do { printf("Block number : %u", (unsigned int)(MSC_Handle ->unit[MSC_Handle ->current_lun]. capacity . block_nbr)); printf("\n"); } while (0);
                do { printf("Block Size   : %u", (unsigned int)(MSC_Handle ->unit[MSC_Handle ->current_lun]. capacity . block_size)); printf("\n"); } while (0);
              }
...
USBH_StatusTypeDef USBH_MSC_GetLUNInfo(USBH_HandleTypeDef *phost, uint8_t lun, MSC_LUNTypeDef *info)
{
  ...
  {
    (void)memcpy(info, &MSC_Handle->unit[lun], sizeof(MSC_LUNTypeDef));
    return USBH_OK;
  }
  else
  {
