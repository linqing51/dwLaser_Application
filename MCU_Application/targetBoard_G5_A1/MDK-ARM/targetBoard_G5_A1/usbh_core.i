...
#line 22 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
...
#line 145 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"

   
  phost->os_event = osMessageQueueNew(0x10U, sizeof(uint32_t), 0);

   
  USBH_Thread_Atrr.name = "USBH_Queue";


  USBH_Thread_Atrr.stack_size = ((uint16_t)512);




  USBH_Thread_Atrr.priority = osPriorityNormal;
...
#line 202 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
...
static USBH_StatusTypeDef DeInitStateMachine(USBH_HandleTypeDef *phost)
{
  ...
  memset(&phost->device.CfgDesc_Raw, 0, sizeof(phost->device.CfgDesc_Raw));
  memset(&phost->device.Data, 0, sizeof(phost->device.Data));
...
USBH_StatusTypeDef USBH_Process(USBH_HandleTypeDef *phost)
{
  ...
  switch (phost->gState)
  {
    ...
    case  HOST_SET_WAKEUP_FEATURE:
      ...
      {
        status = USBH_SetFeature(phost, 0X01U);
        ...
        {
          do { printf("Remote wakeup not supported by the device"); printf("\n"); } while (0);
          phost->gState = HOST_CHECK_CLASS;
        }
        else
        {
...
#line 1265 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
...
#line 1292 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
static void USBH_Process_OS(void *argument)
{
  osStatus_t status;
  ...
  for (;;)
  {
    status = osMessageQueueGet(((USBH_HandleTypeDef *)argument)->os_event,
                               &((USBH_HandleTypeDef *)argument)->os_msg, 0, 0xFFFFFFFFU);
    if (status == osOK)
    {
