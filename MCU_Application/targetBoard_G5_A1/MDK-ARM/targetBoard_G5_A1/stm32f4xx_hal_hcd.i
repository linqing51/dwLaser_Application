...
#line 150 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
#line 311 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
#line 1048 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
                                        ...
                                        uint8_t addr, uint8_t PortNbr)
{
  ...
  if ((hhcd->hc[ch_num].speed != 0U) && (HostCoreSpeed == 0U))
  {
    hhcd->hc[ch_num].do_ssplit = 1U;

    if ((hhcd->hc[ch_num].ep_type == 0U) && (hhcd->hc[ch_num].ep_is_in != 0U))
    {
...
static void HCD_HC_IN_IRQHandler(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
  ...
  if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (2U)))) == ((0x1UL << (2U)))))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (2U))));
    hhcd->hc[chnum].state = HC_XACTERR;
    (void)USB_HC_Halt(hhcd->Instance, chnum);
  }
  else if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (8U)))) == ((0x1UL << (8U)))))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (8U))));
    hhcd->hc[chnum].state = HC_BBLERR;
    (void)USB_HC_Halt(hhcd->Instance, chnum);
  }
  else if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (3U)))) == ((0x1UL << (3U)))))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (3U))));
    hhcd->hc[chnum].state = HC_STALL;
    (void)USB_HC_Halt(hhcd->Instance, chnum);
  }
  else if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (10U)))) == ((0x1UL << (10U)))))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (10U))));
    hhcd->hc[chnum].state = HC_DATATGLERR;
    (void)USB_HC_Halt(hhcd->Instance, chnum);
  }
  else if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (7U)))) == ((0x1UL << (7U)))))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (7U))));
    hhcd->hc[chnum].state = HC_XACTERR;
    (void)USB_HC_Halt(hhcd->Instance, chnum);
  }
  else
  ...
  if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))))
  {
    (void)USB_HC_Halt(hhcd->Instance, chnum);
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (9U))));
  }
  else if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (0U)))) == ((0x1UL << (0U)))))
  {
     
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (5U))));

    if (hhcd->hc[chnum].do_csplit == 1U)
    {
      hhcd->hc[chnum].do_csplit = 0U;
      (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCSPLT &= ~(0x1UL << (16U)));
    }

    if (hhcd->Init.dma_enable != 0U)
    {
      hhcd->hc[chnum].xfer_count = hhcd->hc[chnum].XferSize - (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCTSIZ & (0x7FFFFUL << (0U)));
    }

    hhcd->hc[chnum].state = HC_XFRC;
    hhcd->hc[chnum].ErrCnt = 0U;
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (0U))));

    if ((hhcd->hc[chnum].ep_type == 0U) ||
        (hhcd->hc[chnum].ep_type == 2U))
    {
      (void)USB_HC_Halt(hhcd->Instance, chnum);
      (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (4U))));
    }
    else if ((hhcd->hc[chnum].ep_type == 3U) ||
             (hhcd->hc[chnum].ep_type == 1U))
    {
      ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCCHAR |= (0x1UL << (29U));
  ...
  else if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (5U)))) == ((0x1UL << (5U)))))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (5U))));
  ...
  else if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (1U)))) == ((0x1UL << (1U)))))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (1U))));
    ...
    else if (hhcd->hc[chnum].state == HC_ACK)
    {
      ...
      if (hhcd->hc[chnum].do_csplit == 1U)
      {
        ...
        ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCSPLT |= (0x1UL << (16U));
        ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINTMSK |= (0x1UL << (6U));
        ((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINTMSK &= ~(0x1UL << (5U));
  ...
  else if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (6U)))) == ((0x1UL << (6U)))))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (6U))));
  ...
  else if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (4U)))) == ((0x1UL << (4U)))))
  {
    if (hhcd->hc[chnum].ep_type == 3U)
    {
      hhcd->hc[chnum].ErrCnt = 0U;
    ...
    else if ((hhcd->hc[chnum].ep_type == 0U) ||
             (hhcd->hc[chnum].ep_type == 2U))
    {
      hhcd->hc[chnum].ErrCnt = 0U;
...
static void HCD_HC_OUT_IRQHandler(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
  ...
  else if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))))
  {
    (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCINT = ((0x1UL << (9U))));
    (void)USB_HC_Halt(hhcd->Instance, chnum);
  }
  else if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (0U)))) == ((0x1UL << (0U)))))
  {
    ...
    if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (6U)))) == ((0x1UL << (6U)))))
    {
  ...
  else if (((USB_ReadChInterrupts((hhcd)->Instance, (chnum)) & ((0x1UL << (1U)))) == ((0x1UL << (1U)))))
  {
    ...
    if (hhcd->hc[chnum].state == HC_XFRC)
    {
      ...
      if ((hhcd->hc[chnum].ep_type == 2U) ||
          (hhcd->hc[chnum].ep_type == 3U))
      {
        if (hhcd->Init.dma_enable == 0U)
        {
    ...
    case 2U:
      ...
      if ((pktcnt > 0U) && (hhcd->hc[chnum].xfer_buff != (void *)0))
      {
        if ((hhcd->hc[chnum].xfer_count + pktcnt) <= hhcd->hc[chnum].xfer_len)
        {
          ...
          xferSizePktCnt = (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((chnum) * 0x20UL)))->HCTSIZ & (0x3FFUL << (19U))) >> 19;
