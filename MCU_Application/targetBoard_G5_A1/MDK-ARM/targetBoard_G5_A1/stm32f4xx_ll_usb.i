  ...
  if (ep->is_in == 1U)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x900UL + ((epnum) * 0x20UL)))->DIEPTSIZ |= ((0x3FFUL << (19U)) & (pktcnt << 19));

        if (ep->type == 1U)
        {
          ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x900UL + ((epnum) * 0x20UL)))->DIEPTSIZ &= ~((0x3UL << (29U)));
          ((USB_OTG_INEndpointTypeDef *)(USBx_BASE + 0x900UL + ((epnum) * 0x20UL)))->DIEPTSIZ |= ((0x3UL << (29U)) & (pktcnt << 29));
        }
      }
...
#line 1461 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
  ...
  USBx->GCCFG &= ~(0x1UL << (19U));
  USBx->GCCFG &= ~(0x1UL << (18U));
#line 1477 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usb.c"
