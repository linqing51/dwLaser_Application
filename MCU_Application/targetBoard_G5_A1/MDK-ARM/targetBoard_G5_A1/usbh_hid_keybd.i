#line 1 "../Middlewares/ST/STM32_USB_Host_Library/Class/HID/Src/usbh_hid_keybd.c"
...
#line 30 "../Middlewares/ST/STM32_USB_Host_Library/Class/HID/Src/usbh_hid_keybd.c"
...
#line 31 "../Middlewares/ST/STM32_USB_Host_Library/Class/HID/Src/usbh_hid_keybd.c"
...
#line 75 "../Middlewares/ST/STM32_USB_Host_Library/Class/HID/Src/usbh_hid_keybd.c"
...
uint8_t                   keybd_rx_report_buf[0x8U];
uint8_t                   keybd_report_data[0x8U];
...
#line 369 "../Middlewares/ST/STM32_USB_Host_Library/Class/HID/Src/usbh_hid_keybd.c"
...
USBH_StatusTypeDef USBH_HID_KeybdInit(USBH_HandleTypeDef *phost)
{
  ...
  if ((10U * sizeof(keybd_report_data)) > sizeof(phost->device.Data))
  {
    return USBH_FAIL;
  }
  else
  {
    USBH_HID_FifoInit(&HID_Handle->fifo, phost->device.Data, (uint16_t)(10U * sizeof(keybd_report_data)));
  }
...
static USBH_StatusTypeDef USBH_HID_KeybdDecode(USBH_HandleTypeDef *phost)
{
  ...
  if ((HID_Handle->length == 0U) || (HID_Handle->fifo.buf == 0))
  {
    return USBH_FAIL;
  }
