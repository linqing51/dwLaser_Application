#line 1 "..\\..\\MainApp\\dcHmiLanguage.c"
...
#line 27 "../../sPlc/sPlc.h"
#line 1 "../../MainApp/dcHmiLanguage.H"
#line 31 "../../MainApp/dcHmiLanguage.H"
...
#line 2 "..\\..\\MainApp\\dcHmiLanguage.c"
 
const char WARN_MSG_NO_ERROR[]	        		 		= {""};			
const char WARN_MSG_INTERLOCK_UNPLUG[]		 	 	= {"Door interlock disconnected"};
const char WARN_MSG_FOOTSWITCH_UNPLUG[]			= {"Footswitch not connected"};
const char WARN_MSG_ESTOP_PRESS[]            	= {"ESTOP Press"};
const char WARN_MSG_FIBER_UNPLUG[] 					= {"No fiber connected"};
const char WARN_MSG_OUT_ENERGY[] 				 		= {"Energy out of tolerance"};
const char WARN_MSG_DIODE_HTEMP[] 				 		= {"Laser overheating"};
const char WARN_MSG_DIODE_LTEMP[] 				 		= {"Laser NTC open or lowheating"};
const char WARN_MSG_DIODE0_OVERCURRENT[] 		= {"Laser current exceeds set value"};
const char WARN_MSG_DIODE1_OVERCURRENT[] 		= {"Laser current exceeds set value"};
const char WARN_MSG_NTC_ERROR[] 					 		= {"Thermistor Error"};
const char WARN_MSG_ENVI_HTEMP[] 				 		= {"Envi High Temperature"};
const char WARN_MSG_ENVI_LTEMP[] 				 		= {"Envi Low Temperature"};
const char WARN_MSG_FOOT_DEPRESSED[] 			 	= {"Foot/finger switch is depressed"};
const char WARN_MSG_LASER_EMIT[] 				 		= {"Laser is firing"};
const char WARN_MSG_WAIT_TRIGGER[] 				 	= {"Wait Laser Trigger"};
