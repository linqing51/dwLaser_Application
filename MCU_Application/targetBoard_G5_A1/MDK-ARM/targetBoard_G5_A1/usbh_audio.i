#line 1 "../Middlewares/ST/STM32_USB_Host_Library/Class/AUDIO/Src/usbh_audio.c"
...
#line 41 "../Middlewares/ST/STM32_USB_Host_Library/Class/AUDIO/Src/usbh_audio.c"
...
static USBH_StatusTypeDef USBH_AUDIO_InterfaceInit(USBH_HandleTypeDef *phost)
{
  ...
  interface = USBH_FindInterface(phost, 0x01U, 0x01U, 0x00U);
  ...
  phost->pActiveClass->pData = (AUDIO_HandleTypeDef *)malloc(sizeof(AUDIO_HandleTypeDef));
  AUDIO_Handle = (AUDIO_HandleTypeDef *) phost->pActiveClass->pData;

  if (AUDIO_Handle == 0)
  {
    do { printf("DEBUG : "); printf("Cannot allocate memory for AUDIO Handle"); printf("\n"); } while (0);
    return USBH_FAIL;
  }

   
  (void)memset(AUDIO_Handle, 0, sizeof(AUDIO_HandleTypeDef));
  ...
  {
    do { printf("DEBUG : "); printf("%s class configuration not supported.", phost->pActiveClass->Name); printf("\n"); } while (0);
    return USBH_FAIL;
  }
...
static USBH_StatusTypeDef USBH_AUDIO_InterfaceDeInit(USBH_HandleTypeDef *phost)
{
  ...
  if (AUDIO_Handle->microphone.Pipe != 0x00U)
  {
    ...
    AUDIO_Handle->microphone.Pipe = 0U;      
  }
  ...
  if (AUDIO_Handle->headphone.Pipe != 0x00U)
  {
    ...
    AUDIO_Handle->headphone.Pipe = 0U;      
  }
  ...
  switch (AUDIO_Handle->req_state)
  {
    ...
    case AUDIO_REQ_SET_DEFAULT_IN_INTERFACE:
      if (AUDIO_Handle->microphone.supported == 1U)
      {
        ...
        {
          do { printf("ERROR: "); printf("Control error: AUDIO: Device Set interface request failed"); printf("\n"); } while (0);
          status = USBH_FAIL;
        }
        else
        {
  ...
  switch (AUDIO_Handle->cs_req_state)
  {
    case AUDIO_REQ_GET_VOLUME:
      ...
      if (req_status != USBH_BUSY)
      {
        ...
        VolumeCtl = (((uint16_t)(&(AUDIO_Handle ->mem[0]))[0]) | ((uint16_t)(((uint32_t)(&(AUDIO_Handle ->mem[0]))[1]) << 8)));
    ...
    case AUDIO_REQ_GET_RESOLUTION:
      ...
      if (req_status != USBH_BUSY)
      {
        ...
        ResolutionCtl = (((uint16_t)(&AUDIO_Handle ->mem[0])[0]) | ((uint16_t)(((uint32_t)(&AUDIO_Handle ->mem[0])[1]) << 8)));
...
static USBH_StatusTypeDef USBH_AUDIO_FindAudioStreamingIN(USBH_HandleTypeDef *phost)
{
  ...
  {
    if ((phost->device.CfgDesc.Itf_Desc[interface].bInterfaceClass == 0x01U) &&
        (phost->device.CfgDesc.Itf_Desc[interface].bInterfaceSubClass == 0x02U))
    {
...
static USBH_StatusTypeDef USBH_AUDIO_FindHIDControl(USBH_HandleTypeDef *phost)
{
  ...
  interface = USBH_FindInterface(phost, 0x01U, 0x01U, 0xFFU);
  ...
  while (ptr < phost->device.CfgDesc.wTotalLength)
  {
    ...
    switch (pdesc->bDescriptorType)
    {
      ...
      case 0x24U:
        ...
        {
          if ((itf_index == 0xFFU) || (itf_index >= 10U))  
          {
            do { printf("DEBUG : "); printf("Cannot Find the audio interface index for %s class.", phost->pActiveClass->Name); printf("\n"); } while (0);
            status = USBH_FAIL;
          }
          else
          {
...
static uint32_t USBH_AUDIO_FindLinkedUnit(USBH_HandleTypeDef *phost, uint8_t UnitID)
{
  ...
  for (Index = 0U; Index < AUDIO_Handle->class_desc.FeatureUnitNum; Index ++)
  {
    if (AUDIO_Handle->class_desc.cs_desc.FeatureUnitDesc[Index]->bSourceID == UnitID)
    {
      ...
      return (((uint32_t)UnitID << 16U) | (0x06U << 8U) | (uint32_t)Index);
    }
  }
  ...
  for (Index = 0U; Index < AUDIO_Handle->class_desc.MixerUnitNum; Index ++)
  {
        ...
        (AUDIO_Handle->class_desc.cs_desc.MixerUnitDesc[Index]->bSourceID1 == UnitID))
    {
      ...
      return (uint32_t)((UnitID << 16U) | (0x04U << 8U) | Index);
    }
  }
  ...
  for (Index = 0U; Index < AUDIO_Handle->class_desc.SelectorUnitNum; Index ++)
  {
    if (AUDIO_Handle->class_desc.cs_desc.SelectorUnitDesc[Index]->bSourceID0 == UnitID)
    {
      ...
      return (uint32_t)((UnitID << 16U) | (0x05U << 8U) | Index);
    }
  }
  ...
  for (Index = 0U; Index < AUDIO_Handle->class_desc.OutputTerminalNum; Index ++)
  {
    if (AUDIO_Handle->class_desc.cs_desc.OutputTerminalDesc[Index]->bSourceID == UnitID)
    {
      ...
      return (uint32_t)((UnitID << 16U) | (0x03U << 8U) | Index);
    }
  }
...
static USBH_StatusTypeDef USBH_AUDIO_BuildMicrophonePath(USBH_HandleTypeDef *phost)
{
  ...
  {
    if ((((uint16_t)(AUDIO_Handle ->class_desc . cs_desc . InputTerminalDesc[terminalIndex]->wTerminalType)[0]) | ((uint16_t)(((uint32_t)(AUDIO_Handle ->class_desc . cs_desc . InputTerminalDesc[terminalIndex]->wTerminalType)[1]) << 8))) == 0x201U)
    {
...
static USBH_StatusTypeDef USBH_AUDIO_BuildHeadphonePath(USBH_HandleTypeDef *phost)
{
  ...
  for (terminalIndex = 0U; terminalIndex < AUDIO_Handle->class_desc.InputTerminalNum; terminalIndex++)
  {
    if ((((uint16_t)(AUDIO_Handle ->class_desc . cs_desc . InputTerminalDesc[terminalIndex]->wTerminalType)[0]) | ((uint16_t)(((uint32_t)(AUDIO_Handle ->class_desc . cs_desc . InputTerminalDesc[terminalIndex]->wTerminalType)[1]) << 8))) == 0x101U)
    {
      UnitID = AUDIO_Handle->class_desc.cs_desc.InputTerminalDesc[terminalIndex]->bTerminalID;
  ...
  do
  {
    ...
    switch (Type)
    {
      ...
      case 0x03U:
        ...
        if (Index < 4U)
        {
          if ((((uint16_t)(AUDIO_Handle ->class_desc . cs_desc . OutputTerminalDesc[Index]->wTerminalType)[0]) | ((uint16_t)(((uint32_t)(AUDIO_Handle ->class_desc . cs_desc . OutputTerminalDesc[Index]->wTerminalType)[1]) << 8))) != 0x103U)
          {
            return  USBH_OK;
          }
        }
                                         ...
                                         uint16_t length)
{
  ...
  phost->Control.setup.b.bRequest = (0x00U | 0x01U);
                                         ...
                                         uint16_t length)
{
  ...
  phost->Control.setup.b.bmRequestType = 0x80U | 0x01U |                                          0x20U;


  phost->Control.setup.b.bRequest = (0x80U | 0x01U);
  phost->Control.setup.b.wValue.w = wValue;
  phost->Control.setup.b.wIndex.w = wIndex;
  phost->Control.setup.b.wLength.w = wLength;
                                         ...
                                         uint16_t length)
{
  ...
  phost->Control.setup.b.bRequest = (0x80U | 0x03U);
  phost->Control.setup.b.wValue.w = wValue;
  phost->Control.setup.b.wIndex.w = wIndex;
  phost->Control.setup.b.wLength.w = wLength;
                                         ...
                                         uint16_t length)
{
  ...
  phost->Control.setup.b.bmRequestType = 0x80U | 0x01U
                                         | 0x20U;

  phost->Control.setup.b.bRequest = (0x80U | 0x04U);
  phost->Control.setup.b.wValue.w = wValue;
  phost->Control.setup.b.wIndex.w = wIndex;
  phost->Control.setup.b.wLength.w = wLength;
                                         ...
                                         uint16_t length)
{
  ...
  phost->Control.setup.b.bRequest = (0x80U | 0x02U);
  phost->Control.setup.b.wValue.w = wValue;
  phost->Control.setup.b.wIndex.w = wIndex;
  phost->Control.setup.b.wLength.w = wLength;
                                                         ...
                                                         uint8_t *buff)
{
  ...
  phost->Control.setup.b.bmRequestType = 0x00U | 0x02U |                                          0x20U;
...
static USBH_StatusTypeDef USBH_AUDIO_Control(USBH_HandleTypeDef *phost)
{
  ...
  switch (AUDIO_Handle->control_state)
  {
    ...
    case AUDIO_CONTROL_CHANGE:
      ...
      {
        attribute = (((uint16_t)(&AUDIO_Handle ->mem[0])[0]) | ((uint16_t)(((uint32_t)(&AUDIO_Handle ->mem[0])[1]) << 8)));
                                           ...
                                           uint8_t  BitPerSample)
{
  ...
  if (phost->gState == HOST_CLASS)
  {
    ...
    if (AUDIO_Handle->play_state == AUDIO_PLAYBACK_IDLE)
    {
      if (AUDIO_Handle->class_desc.as_desc[AUDIO_Handle->headphone.asociated_as].FormatTypeDesc->bSamFreqType == 0U)
      {
        freq_min = (((uint32_t)(AUDIO_Handle ->class_desc . as_desc[AUDIO_Handle ->headphone . asociated_as]. FormatTypeDesc->tSamFreq[0])[0]) | (((uint32_t)(AUDIO_Handle ->class_desc . as_desc[AUDIO_Handle ->headphone . asociated_as]. FormatTypeDesc->tSamFreq[0])[1]) << 8) | (((uint32_t)(AUDIO_Handle ->class_desc . as_desc[AUDIO_Handle ->headphone . asociated_as]. FormatTypeDesc->tSamFreq[0])[2]) << 16));
        freq_max = (((uint32_t)(AUDIO_Handle ->class_desc . as_desc[AUDIO_Handle ->headphone . asociated_as]. FormatTypeDesc->tSamFreq[1])[0]) | (((uint32_t)(AUDIO_Handle ->class_desc . as_desc[AUDIO_Handle ->headphone . asociated_as]. FormatTypeDesc->tSamFreq[1])[1]) << 8) | (((uint32_t)(AUDIO_Handle ->class_desc . as_desc[AUDIO_Handle ->headphone . asociated_as]. FormatTypeDesc->tSamFreq[1])[2]) << 16));
      ...
      else
      {
        ...
        {
          if (SampleRate == (((uint32_t)(AUDIO_Handle ->class_desc . as_desc[AUDIO_Handle ->headphone . asociated_as]. FormatTypeDesc->tSamFreq[index])[0]) | (((uint32_t)(AUDIO_Handle ->class_desc . as_desc[AUDIO_Handle ->headphone . asociated_as]. FormatTypeDesc->tSamFreq[index])[1]) << 8) | (((uint32_t)(AUDIO_Handle ->class_desc . as_desc[AUDIO_Handle ->headphone . asociated_as]. FormatTypeDesc->tSamFreq[index])[2]) << 16)))
      ...
      {
        do { printf("ERROR: "); printf("Sample Rate not supported by the Audio Device"); printf("\n"); } while (0);
      }
    }
  }
  return Status;
...
static USBH_StatusTypeDef AUDIO_SetVolume(USBH_HandleTypeDef *phost, uint8_t feature, uint8_t channel, uint16_t volume)
{
  ...
  status = USBH_AC_SetCur(phost, 0x06U, feature,
                          0x02U, channel, 2U);
