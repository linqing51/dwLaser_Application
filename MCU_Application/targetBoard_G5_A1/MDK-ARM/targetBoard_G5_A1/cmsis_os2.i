...
#line 24 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.c"
...
#line 27 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.c"
...
#line 30 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.c"
...
#line 1 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_mpool.h"
...
#line 27 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_mpool.h"
#line 28 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_mpool.h"
#line 29 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_mpool.h"
...
#line 1 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_os2.h"
...
#line 27 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_os2.h"
#line 28 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_os2.h"

#line 30 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_os2.h"
...
#line 32 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_os2.h"
...
#line 211 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_os2.h"

#line 227 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_os2.h"

#line 243 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_os2.h"

#line 268 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_os2.h"

#line 283 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_os2.h"

#line 292 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_os2.h"

#line 309 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/freertos_os2.h"

#line 35 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.c"

 
#line 52 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.c"

#line 67 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.c"

#line 77 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.c"
...
#line 146 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.c"
...
static __inline void SVC_Setup (void) {

   
   
   
  __NVIC_SetPriority ((IRQn_Type) -5, 0U);
...
#line 212 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.c"
...
osStatus_t osKernelGetInfo (osVersion_t *version, char *id_buf, uint32_t id_size) {
  ...
  if (version != 0) {
    ...
    version->api    = (((uint32_t)10 * 10000000UL) | ((uint32_t)3 * 10000UL) | ((uint32_t)1 * 1UL));
    version->kernel = (((uint32_t)10 * 10000000UL) | ((uint32_t)3 * 10000UL) | ((uint32_t)1 * 1UL));
  }

  if ((id_buf != 0) && (id_size != 0U)) {
    if (id_size > sizeof(("FreeRTOS " "V10.3.1"))) {
      id_size = sizeof(("FreeRTOS " "V10.3.1"));
    }
    memcpy(id_buf, ("FreeRTOS " "V10.3.1"), id_size);
  }
...
static uint32_t OS_Tick_GetCount (void) {
  uint32_t load = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD;
  return  (load - ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL);
}

 
static uint32_t OS_Tick_GetOverflow (void) {
  return ((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL >> 16) & 1U);
}

 
static uint32_t OS_Tick_GetInterval (void) {
  return (((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD + 1U);
}

uint32_t osKernelGetSysTimerCount (void) {
  uint32_t irqmask = ((__get_PRIMASK() != 0U) || (__get_BASEPRI() != 0U));
  TickType_t ticks;
  uint32_t val;
...
uint32_t osThreadEnumerate (osThreadId_t *thread_array, uint32_t array_items) {
  ...
  if ((__get_IPSR() != 0U) || (thread_array == 0) || (array_items == 0U)) {
    count = 0U;
  } else {
    vTaskSuspendAll();
...
osSemaphoreId_t osSemaphoreNew (uint32_t max_count, uint32_t initial_count, const osSemaphoreAttr_t *attr) {
  ...
  if (!(__get_IPSR() != 0U) && (max_count > 0U) && (initial_count <= max_count)) {
    mem = -1;
...
osMessageQueueId_t osMessageQueueNew (uint32_t msg_count, uint32_t msg_size, const osMessageQueueAttr_t *attr) {
  ...
  if (!(__get_IPSR() != 0U) && (msg_count > 0U) && (msg_size > 0U)) {
    mem = -1;
...
osMemoryPoolId_t osMemoryPoolNew (uint32_t block_count, uint32_t block_size, const osMemoryPoolAttr_t *attr) {
  ...
  if ((__get_IPSR() != 0U)) {
    ...
    mp = 0;
    sz = (((((block_size) + (4 - 1)) / 4) * 4)*(block_count));
    ...
    if (attr != 0) {
      ...
      if ((attr->cb_mem != 0) && (attr->cb_size >= sizeof(MemPool_t))) {
         
        mem_cb = 1;
      }
      else if ((attr->cb_mem == 0) && (attr->cb_size == 0U)) {
         
        mem_cb = 0;
      }

      if ((attr->mp_mem == 0) && (attr->mp_size == 0U)) {
    ...
    if (mp != 0) {
        ...
        mp->sem = xQueueCreateCountingSemaphoreStatic( ( block_count ), ( block_count ), ( &mp->mem_sem ) );
...
void *osMemoryPoolAlloc (osMemoryPoolId_t mp_id, uint32_t timeout) {
  ...
  if (mp_id == 0) {
    ...
    if ((mp->status & 0x5EED0000U) == 0x5EED0000U) {
      if ((__get_IPSR() != 0U)) {
        if (timeout == 0U) {
          if (xQueueReceiveFromISR( ( QueueHandle_t ) ( mp->sem ), 0, ( 0 ) ) == ( ( BaseType_t ) 1 )) {
            if ((mp->status & 0x5EED0000U) == 0x5EED0000U) {
              isrm  = ulPortRaiseBASEPRI();
        ...
        if (xQueueSemaphoreTake( ( mp->sem ), ( (TickType_t)timeout ) ) == ( ( BaseType_t ) 1 )) {
          if ((mp->status & 0x5EED0000U) == 0x5EED0000U) {
            vPortEnterCritical();
...
osStatus_t osMemoryPoolFree (osMemoryPoolId_t mp_id, void *block) {
  ...
  if ((mp_id == 0) || (block == 0)) {
    ...
    if ((mp->status & 0x5EED0000U) != 0x5EED0000U) {
      ...
      if ((__get_IPSR() != 0U)) {
        if (uxQueueMessagesWaitingFromISR( ( QueueHandle_t ) ( mp->sem ) ) == mp->bl_cnt) {
          stat = osErrorResource;
        }
        else {
          isrm = ulPortRaiseBASEPRI();
          ...
          yield = ( ( BaseType_t ) 0 );
          xQueueGiveFromISR( ( QueueHandle_t ) ( mp->sem ), ( &yield ) );
          if( yield != ( ( BaseType_t ) 0 ) ) { ( * ( ( volatile uint32_t * ) 0xe000ed04 ) ) = ( 1UL << 28UL ); __dsb( ( 15 ) ); __isb( ( 15 ) ); };
        }
      }
      else {
        if (uxQueueMessagesWaiting( ( QueueHandle_t ) ( mp->sem ) ) == mp->bl_cnt) {
          stat = osErrorResource;
        }
        else {
          vPortEnterCritical();
          ...
          xQueueGenericSend( ( QueueHandle_t ) ( mp->sem ), 0, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        }
      }
    }
  }
...
uint32_t osMemoryPoolGetCount (osMemoryPoolId_t mp_id) {
  ...
  if (mp_id == 0) {
    ...
    if ((mp->status & 0x5EED0000U) != 0x5EED0000U) {
      ...
      if ((__get_IPSR() != 0U)) {
        n = uxQueueMessagesWaitingFromISR( ( QueueHandle_t ) ( mp->sem ) );
      } else {
        n = uxQueueMessagesWaiting( ( QueueHandle_t ) ( mp->sem ) );
      }
...
osStatus_t osMemoryPoolDelete (osMemoryPoolId_t mp_id) {
  ...
  if (mp_id == 0) {
    ...
    while (xQueueGenericSend( ( QueueHandle_t ) ( mp->sem ), 0, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ));
...
#line 2448 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.c"
...
__attribute__((weak)) void vApplicationGetIdleTaskMemory (StaticTask_t **ppxIdleTaskTCBBuffer, StackType_t **ppxIdleTaskStackBuffer, uint32_t *pulIdleTaskStackSize) {
  ...
  static StackType_t  Idle_Stack[((uint16_t)512)];

  *ppxIdleTaskTCBBuffer   = &Idle_TCB;
  *ppxIdleTaskStackBuffer = &Idle_Stack[0];
  *pulIdleTaskStackSize   = (uint32_t)((uint16_t)512);
}
...
__attribute__((weak)) void vApplicationGetTimerTaskMemory (StaticTask_t **ppxTimerTaskTCBBuffer, StackType_t **ppxTimerTaskStackBuffer, uint32_t *pulTimerTaskStackSize) {
  ...
  static StackType_t  Timer_Stack[1024];

  *ppxTimerTaskTCBBuffer   = &Timer_TCB;
  *ppxTimerTaskStackBuffer = &Timer_Stack[0];
  *pulTimerTaskStackSize   = (uint32_t)1024;
}
