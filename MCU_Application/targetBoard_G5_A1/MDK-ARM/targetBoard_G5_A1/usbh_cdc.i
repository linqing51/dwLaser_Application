#line 1 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
...
#line 50 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
...
static USBH_StatusTypeDef USBH_CDC_InterfaceInit(USBH_HandleTypeDef *phost)
{
  ...
  {
    do { printf("DEBUG : "); printf("Cannot Find the interface for Communication Interface Class.", phost->pActiveClass->Name); printf("\n"); } while (0);
    return USBH_FAIL;
  }
  ...
  if (CDC_Handle == 0)
  {
    do { printf("DEBUG : "); printf("Cannot allocate memory for CDC Handle"); printf("\n"); } while (0);
    return USBH_FAIL;
  }

   
  (void)memset(CDC_Handle, 0, sizeof(CDC_HandleTypeDef));
  ...
  if ((interface == 0xFFU) || (interface >= 10U))  
  {
    do { printf("DEBUG : "); printf("Cannot Find the interface for Data Interface Class.", phost->pActiveClass->Name); printf("\n"); } while (0);
    return USBH_FAIL;
  }
...
static USBH_StatusTypeDef USBH_CDC_ClassRequest(USBH_HandleTypeDef *phost)
{
  ...
  {
    do { printf("ERROR: "); printf("Control error: CDC: Device Get Line Coding configuration failed"); printf("\n"); } while (0);
  }
  else
  {
...
static USBH_StatusTypeDef GetLineCoding(USBH_HandleTypeDef *phost, CDC_LineCodingTypeDef *linecoding)
{
  ...
  phost->Control.setup.b.bmRequestType = 0x80U | 0x20U |                                          0x01U;
...
#line 766 "../Middlewares/ST/STM32_USB_Host_Library/Class/CDC/Src/usbh_cdc.c"
      else
      {
