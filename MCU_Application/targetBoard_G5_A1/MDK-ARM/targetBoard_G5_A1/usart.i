...
void MX_UART4_Init(void)
{
  ...
  huart4.Instance = ((USART_TypeDef *) (0x40000000UL + 0x4C00UL));
  huart4.Init.BaudRate = 115200;
  huart4.Init.WordLength = 0x00000000U;
  huart4.Init.StopBits = 0x00000000U;
  huart4.Init.Parity = 0x00000000U;
  huart4.Init.Mode = ((uint32_t)((0x1UL << (3U)) | (0x1UL << (2U))));
  huart4.Init.HwFlowCtl = 0x00000000U;
  huart4.Init.OverSampling = 0x00000000U;
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) (0x40000000UL + 0x4C00UL)))
  {
   

   
     
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (19U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (19U)))); (void)tmpreg; } while(0U);
  ...
  else if(uartHandle->Instance==((USART_TypeDef *) (0x40000000UL + 0x4400UL)))
  {
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) (0x40000000UL + 0x4C00UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (19U))));

    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x0001)|((uint16_t)0x0002));
