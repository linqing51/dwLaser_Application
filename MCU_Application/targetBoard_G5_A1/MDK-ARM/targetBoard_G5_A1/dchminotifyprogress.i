#line 1 "..\\..\\MainApp\\dcHmiNotifyProgress.c"
#line 1 "..\\..\\MainApp\\dcHmiNotifyProgress.h"
...
#line 5 "..\\..\\MainApp\\dcHmiNotifyProgress.h"
...
#line 2 "..\\..\\MainApp\\dcHmiNotifyProgress.c"
			...
			switch(control_id){
				case 39:{
					...
					if(NVRAM0[(576 + 55)] == 0x01){
						fpwr = (float)value / 100 * 150;
						if(fpwr < 1){
							fpwr = 1;
						}
						NVRAM0[(576 + 57)] = (int16_t)fpwr;
					}
					if(NVRAM0[(576 + 55)] == 0x02){
						...
						NVRAM0[(576 + 58)] = (int16_t)fpwr;
					}
					if(NVRAM0[(576 + 55)] == 0x05){
						fpwr = (float)value / 100 * 5;
						if(fpwr < 1){
							fpwr = 1;
						}
						NVRAM0[(576 + 61)] = (int16_t)fpwr;
					}
				...
				case 40:{
					...
					fpwr = (float)value / 100 * 150 * 10.0F;
					NVRAM0[(576 + 64)] = (int16_t)fpwr;
					NVRAM0[(576 + 85)] = NVRAM0[(576 + 57)] + NVRAM0[(576 + 58)] + NVRAM0[(576 + 61)];
					updateStandbyDisplay();					
					break;
				}
				...
				case 42:{
					...
					fpwr = (float)value / 100 * 5 * 10.0F;
					NVRAM0[(576 + 68)] = (int16_t)fpwr;
					NVRAM0[(576 + 85)] = NVRAM0[(576 + 57)] + NVRAM0[(576 + 58)] + NVRAM0[(576 + 61)];
					updateStandbyDisplay();
					break;
				}
