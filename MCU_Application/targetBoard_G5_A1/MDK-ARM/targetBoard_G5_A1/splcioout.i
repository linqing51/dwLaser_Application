...
#line 2 "..\\..\\sPlcPort\\sPlcIoOut.c"
extern TIM_HandleTypeDef htim12;
extern TIM_HandleTypeDef htim2;
 
void sPlcOutputInit(void){
	NVRAM0[1312] = 0x0;
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0800), GPIO_PIN_RESET);
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0400), GPIO_PIN_SET);
	printf("%s,%d,%s:output init......\n","..\\..\\sPlcPort\\sPlcIoOut.c", 13, __func__);
}

void sPlcOutputRefresh(void){
	...
	if(LDP((1312 * 16 + 6))){
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0800), GPIO_PIN_SET);
	}
	if(LDN((1312 * 16 + 6))){
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0800), GPIO_PIN_RESET);
	}
