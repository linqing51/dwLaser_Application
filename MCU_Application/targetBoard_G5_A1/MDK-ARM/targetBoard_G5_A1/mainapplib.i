...
uint16_t fitLaserToCode(uint8_t ch, int16_t power, deviceConfig_t *pcfg){
	...
	fpower = (float)power;
	printf("%s,%d,%s:Calibration input power = %d\n", "..\\..\\MainApp\\MainAppLib.c", 153, __func__, power);
	printf("%s,%d,%s:Calibration max power = %d\n", "..\\..\\MainApp\\MainAppLib.c", 154, __func__, pmax);
	printf("%s,%d,%s:Calibration min power = %d\n", "..\\..\\MainApp\\MainAppLib.c", 155, __func__, pmin);
	if(LDB((544 * 16 + 22))){
		...
		fout = (power - fb) / fk;
		printf("%s,%d,%s:Enable calibration mode\n", "..\\..\\MainApp\\MainAppLib.c", 200, __func__);
		printf("%s,%d,%s:Calibration fK=%f, fB=%f\n", "..\\..\\MainApp\\MainAppLib.c", 201, __func__, fk, fb);
		printf("%s,%d,%s:Calibration fOut=%f\n", "..\\..\\MainApp\\MainAppLib.c", 202, __func__, fout);
	}
	else{
		printf("%s,%d,%s:Disable calibration mode\n", "..\\..\\MainApp\\MainAppLib.c", 205, __func__);
		fout = fpower / pmax;			
	}
	fout = fout * 4095.0F;
	if(fout > 4095.0F){
	...
	out = (uint16_t)fout;
	printf("%s,%d,%s:Calibration fOut=%d\n", "..\\..\\MainApp\\MainAppLib.c", 216, __func__, out);
	return out;
}
