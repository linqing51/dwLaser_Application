...
void MX_RNG_Init(void)
{
  ...
  hrng.Instance = ((RNG_TypeDef *) ((0x40000000UL + 0x10000000UL) + 0x60800UL));
...
void HAL_RNG_MspInit(RNG_HandleTypeDef* rngHandle)
{
  ...
  if(rngHandle->Instance==((RNG_TypeDef *) ((0x40000000UL + 0x10000000UL) + 0x60800UL)))
  {
...
void HAL_RNG_MspDeInit(RNG_HandleTypeDef* rngHandle)
{
  ...
  if(rngHandle->Instance==((RNG_TypeDef *) ((0x40000000UL + 0x10000000UL) + 0x60800UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR &= ~((0x1UL << (6U))));
