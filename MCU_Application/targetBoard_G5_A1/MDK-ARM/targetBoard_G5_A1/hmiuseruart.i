...
#line 39 "..\\..\\dcHmi\\hmiUserUart.c"

	printf("%s,%d,%s:start hmi uart init......\n","..\\..\\dcHmi\\hmiUserUart.c", 40, __func__);
}
void hmiUartSendChar(uint8_t sdat){
	HAL_StatusTypeDef ret;

	ret = HAL_UART_Transmit(&huart4, &sdat, 1, 1000);




	if(ret != HAL_OK){
		printf("%s,%d,%s:hmi uart tx timeout!!!!\n","..\\..\\dcHmi\\hmiUserUart.c", 51, __func__);
	}
}
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart){
