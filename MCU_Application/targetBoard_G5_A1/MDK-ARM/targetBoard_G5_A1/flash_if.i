...
uint32_t FLASH_If_EraseApplication(void){	
	...
	NbOfSectors = FLASH_If_GetSectorNumber(((((uint32_t)0x080E0000) + 131072 - 1) - 4)) - FirstSector + 1;
...
uint32_t FLASH_If_EraseBootload(void){
	...
	NbOfSectors = FLASH_If_GetSectorNumber(((((uint32_t)0x08010000) - 1) - 4)) - FirstSector + 1;
	FLASH_EraseInitStruct.TypeErase = 0x00000000U;
	FLASH_EraseInitStruct.Sector = FirstSector;
	FLASH_EraseInitStruct.NbSectors = NbOfSectors;
	FLASH_EraseInitStruct.VoltageRange = 0x00000002U;
...
uint32_t FLASH_If_WriteApplication(uint32_t Address, uint32_t Data)
{
  ...
  if (Address <= (uint32_t)((((uint32_t)0x080E0000) + 131072 - 1) - 4))
  {
...
uint32_t FLASH_lf_WriteBootload(uint32_t Address, uint32_t Data)
{
  ...
  if (Address <= (uint32_t)((((uint32_t)0x08010000) - 1) - 4))
  {
    if (HAL_FLASH_Program(0x00000002U, Address, Data) != HAL_OK)
      return (1);
  }
