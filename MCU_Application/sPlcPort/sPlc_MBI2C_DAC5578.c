 ...
 * @retval 执行状态
 */
static DAC5578_StatusTypeDef DAC5578_I2C_Write(uint8_t *pBuf, uint16_t len)
{
    HAL_StatusTypeDef hal_sta;

    hal_sta = HAL_I2C_Master_Transmit(DAC5578_HI2C, DAC5578_WR_ADDR, pBuf, len, DAC5578_I2C_TIMEOUT);
 ...
 * @retval 执行状态
 */
static DAC5578_StatusTypeDef DAC5578_I2C_Read(uint8_t *pBuf, uint16_t len)
{
    HAL_StatusTypeDef hal_sta;

    hal_sta = HAL_I2C_Master_Receive(DAC5578_HI2C, DAC5578_RD_ADDR, pBuf, len, DAC5578_I2C_TIMEOUT);
