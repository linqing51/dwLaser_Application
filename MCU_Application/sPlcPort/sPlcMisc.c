...
void morseCodeDiag(uint8_t diag){//蜂鸣器诊断声音 摩尔斯电码
	...
	switch(diag){
		case '0':{
			//-
			SET_RLED_ON;HAL_Delay(CONFIG_MORSECODE_SHORT_TIME);SET_RLED_OFF;HAL_Delay(CONFIG_MORSECODE_SPACE_TIME);
			//-
			SET_RLED_ON;HAL_Delay(CONFIG_MORSECODE_LONG_TIME);SET_RLED_OFF;HAL_Delay(CONFIG_MORSECODE_SPACE_TIME);
			//-
			SET_RLED_ON;HAL_Delay(CONFIG_MORSECODE_LONG_TIME);SET_RLED_OFF;HAL_Delay(CONFIG_MORSECODE_SPACE_TIME);
			//-
			SET_RLED_ON;HAL_Delay(CONFIG_MORSECODE_LONG_TIME);SET_RLED_OFF;HAL_Delay(CONFIG_MORSECODE_SPACE_TIME);
			//-
			SET_RLED_ON;HAL_Delay(CONFIG_MORSECODE_LONG_TIME);SET_RLED_OFF;
			break;
		}
		case '1':{
			//.
		...
		case '5':{
			...
			SET_RLED_ON;HAL_Delay(CONFIG_MORSECODE_SHORT_TIME);SET_RLED_OFF;HAL_Delay(CONFIG_MORSECODE_SPACE_TIME);
			//.
			SET_RLED_ON;HAL_Delay(CONFIG_MORSECODE_SHORT_TIME);SET_RLED_OFF;
			break;
		}
		case '6':{
			//-
