...
#define GDDC_PAGE_DISGNOSIS_KEY_DISABLE_FOOTSWITCH						57//屏蔽脚踏检测
#define GDDC_PAGE_DISGNOSIS_KEY_DISABLE_TEMPERATURE						58//屏蔽温度检测
#define GDDC_PAGE_DISGNOSIS_KEY_DISABLE_ESTOP							59//屏蔽急停检测
#define GDDC_PAGE_DISGNOSIS_KEY_DISABLE_INTERLOCK						60//屏蔽安全连锁
