...
#define GDDC_PAGE_STANDBY_KEY_SCHEME_NEXT								9//
#define GDDC_PAGE_STANDBY_KEY_SCHEME_LAST								10//
#define GDDC_PAGE_STANDBY_KEY_AIM_BRG_ADD								11//指示光亮度加
#define GDDC_PAGE_STANDBY_KEY_AIM_BRG_DEC								12//指示光亮度减
#define GDDC_PAGE_STANDBY_KEY_POSWIDTH_ADD								13//	
#define GDDC_PAGE_STANDBY_KEY_POSWIDTH_DEC								14//
#define GDDC_PAGE_STANDBY_KEY_NEGWIDTH_ADD								15//
#define GDDC_PAGE_STANDBY_KEY_NEGWIDTH_DEC								16//
#define GDDC_PAGE_STANDBY_TEXTDISPLAY_NAME								17//方案名称显示
#define GDDC_PAGE_STANDBY_TEXTDISPLAY_SET_POWER							18//设定功率显示
#define GDDC_PAGE_STANDBY_TEXTDISPLAY_WARN								19//报警显示
#define GDDC_PAGE_STANDBY_TEXTDISPLAY_AIM_BRG							20//指示光亮度显示
#define GDDC_PAGE_STANDBY_TEXTDISPLAY_AVERAGE_POWER						21//平均功率显示
#define GDDC_PAGE_STANDBY_TEXTDISPLAY_FREQUENCY							22//频率显示
#define GDDC_PAGE_STANDBY_TEXTDISPLAY_DUTYCYCLE							23//占空比显示
#define GDDC_PAGE_STANDBY_TEXTDISPLAY_POSWIDTH							24//正脉宽显示
#define GDDC_PAGE_STANDBY_TEXTDISPLAY_NEGWIDTH							25//负脉宽显示
#define GDDC_PAGE_STANDBY_PROGRESS_SET_POWER							26//功率设定拖动条
#define GDDC_PAGC_STANDBY_PROGRESS_AIM_BRG								27
...
#define GDDC_PAGE_READY_TEXTDISPLAY_ENERGEY								2//发射能量显示
#define GDDC_PAGE_READY_TEXTDISPLAY_TREATMENT_TIME						3//发射时间显示
#define GDDC_PAGE_READY_TEXTDISPLAY_ACOUSTIC_ENERGEY					4//提示音能量
#define GDDC_PAGE_READY_TEXTDISPLAY_ACOUSTIC_TIME						5//提示音时间
#define GDDC_PAGE_READY_KEY_ACOUSTIC_ENERGEY_ADD						6//提示音能量增加
#define GDDC_PAGE_READY_KEY_ACOUSTIC_ENERGEY_DEC						7//提示音能量减小
#define GDDC_PAGE_READY_KEY_ACOUSTIC_TIME_ADD							8//提示音时间增加
#define GDDC_PAGE_READY_KEY_ACOUSTIC_TIME_DEC							9//提示音时间减小
#define GDDC_PAGE_READY_KEY_READY										10//切换待机按键
...
#define GDDC_PAGE_OPTION_PROGRESS_BEEM_VOLUME							10//蜂鸣器音量调节
...
#define GDDC_PAGE_INFORMATION_TEXTDISPLAY_BUILDTIME						9
/*****************************************************************************/
...
//亮度设置
#define GDDC_PAGE_DISGNOSIS_TEXTDISPLAY_AIM_MAX							140
#define GDDC_PAGE_DISGNOSIS_TEXTDISPLAY_RLED_BRG						141
#define	GDDC_PAGE_DISGNOSIS_TEXTDISPLAY_GLED_BRG						142
#define	GDDC_PAGE_DISGNOSIS_TEXTDISPLAY_YLED_BRG						143
//	
