...
/*	
	sprintf((char*)(&NVRAM0[EM_LASER_SCHEME_NAME]),"Customize %d", (NVRAM0[DM_SCHEME_NUM] - 26));		
	...
	NVRAM0[EM_LASER_POWER_980] = 1;
	NVRAM0[EM_LASER_POWER_635] = 1;
	NVRAM0[EM_LASER_POSWIDTH]= 1000;//正脉宽
	NVRAM0[EM_LASER_NEGWIDTH]= 1000;//负脉宽
	switch(NVRAM0[DM_SCHEME_NUM]){
		case 0:{
			...
			NVRAM0[EM_LASER_POWER_980] = 1;//0.0W
			NVRAM0[EM_LASER_POWER_635] = 1;
			break;
		}
		case 1:{
