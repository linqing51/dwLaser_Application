...
#define TEC_OUT_Pin GPIO_PIN_7
#define TEC_OUT_GPIO_Port GPIOB
#define TEC_SCK_Pin GPIO_PIN_8
#define TEC_SCK_GPIO_Port GPIOB
#define TEC_SYNC_Pin GPIO_PIN_9
#define TEC_SYNC_GPIO_Port GPIOB
#define TEC_PWM_Pin GPIO_PIN_0
#define TEC_PWM_GPIO_Port GPIOE
#define LD1_PWM_Pin GPIO_PIN_1
#define LD1_PWM_GPIO_Port GPIOE
