...
uint32_t mainAppTaskBuffer[ 8192 ];
...
/* USER CODE BEGIN Header_StartMainAppTask */
/**
* @brief Function implementing the mainAppTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartMainAppTask */
__weak void StartMainAppTask(void *argument)
{
  /* USER CODE BEGIN StartMainAppTask */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END StartMainAppTask */
}
