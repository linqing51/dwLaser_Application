...
void MX_DAC_Init(void)
{
  ...
  sConfig.DAC_Trigger = ( (0x2UL << (3U)) | (0x1UL << (2U)));
  sConfig.DAC_OutputBuffer = 0x00000000U;
  if (HAL_DAC_ConfigChannel(&hdac, &sConfig, 0x00000000U) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* dacHandle)
{
  ...
  if(dacHandle->Instance==((DAC_TypeDef *) (0x40000000UL + 0x7400UL)))
  {
    ...
    hdma_dac1.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6000UL) + 0x088UL));
    hdma_dac1.Init.Channel = 0x0E000000U;
    hdma_dac1.Init.Direction = ((uint32_t)(0x1UL << (6U)));
    hdma_dac1.Init.PeriphInc = 0x00000000U;
    hdma_dac1.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_dac1.Init.PeriphDataAlignment = ((uint32_t)(0x1UL << (11U)));
    hdma_dac1.Init.MemDataAlignment = ((uint32_t)(0x1UL << (13U)));
    hdma_dac1.Init.Mode = ((uint32_t)(0x1UL << (8U)));
    hdma_dac1.Init.Priority = 0x00000000U;
    hdma_dac1.Init.FIFOMode = 0x00000000U;
    if (HAL_DMA_Init(&hdma_dac1) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (dacHandle)->DMA_Handle1 = &(hdma_dac1); (hdma_dac1). Parent = (dacHandle); } while(0U);
