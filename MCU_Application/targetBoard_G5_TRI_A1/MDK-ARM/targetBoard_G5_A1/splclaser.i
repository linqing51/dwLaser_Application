...
int8_t LaserFlag_Emiting;
int8_t LaserFlag_Request;
int8_t LaserFlag_Emitover;
 
static void laserStop(void);
static void laserStart(void);
 
#line 126 "..\\..\\sPlcPort\\sPlcLaser.c"
void STLAR(void){
	printf("%s,%d,%s:laser start!\n","..\\..\\sPlcPort\\sPlcLaser.c", 127, __func__);
	if((NVRAM0[(32 + 0)] == 0x0002) && (NVRAM0[(32 + 1)] <= 2)){
		NVRAM0[(1320 + 62)] = 0x15;
	}
	else{
		if(LD((544 * 16 + 23))){
	...
	LaserFlag_Emiting = 0;
	LaserFlag_Emitover = 0;
	((&htim10)->Instance ->CNT = (0x0));
	HAL_TIM_Base_Start_IT(&htim10);
}
void EDLAR(void){
	printf("%s,%d,%s:laser stop!\n","..\\..\\sPlcPort\\sPlcLaser.c", 151, __func__);
	((&htim10)->Instance ->CNT = (0x0));
	...
	LaserTimer_PCounter = 0X0;
	LaserFlag_Emiting = 0;
	LaserFlag_Emitover = 1;
}
void sPlcLaserInit(void){
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0002), GPIO_PIN_RESET);
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x2000), GPIO_PIN_RESET);HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0010), GPIO_PIN_RESET);
	setRedLaserPwm(0);
	...
	LaserFlag_Emiting = 0;
	LaserFlag_Emitover = 0;
	printf("%s,%d,%s:laser timer init......\n","..\\..\\sPlcPort\\sPlcLaser.c", 176, __func__);
}
static void laserStart(void){
	if(LaserFlag_Emiting == 0){
		if(NVRAM0[(576 + 55)] & 0x01){
			HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0002), GPIO_PIN_SET);
		}
		if(NVRAM0[(576 + 55)] & 0x02){
			HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x2000), GPIO_PIN_SET);HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0010), GPIO_PIN_SET);
		}
		if(NVRAM0[(576 + 55)] & 0x05){
			setRedLaserPwm(NVRAM0[(576 + 61)] * 1000);
		}
		LaserFlag_Emiting = 1;
	}
}
static void laserStop(void){
	if(LaserFlag_Emiting == 1){
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0002), GPIO_PIN_RESET);		
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x2000), GPIO_PIN_RESET);HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0010), GPIO_PIN_RESET);
...
void sPlcLaserTimerIsr(void){
	switch(LaserTimer_Mode){
		...
		case 0x02:{
			if((LaserTimer_TCounter >= 0) && (LaserTimer_TCounter < LaserTimer_TMate)){
				laserStart();
			}
			if((LaserTimer_TCounter >= LaserTimer_TMate) && (LaserTimer_TCounter < LaserTimer_TOvertime)){
				laserStop();
			}
			if(LaserTimer_TCounter >= LaserTimer_TOvertime){
...
void setRedLaserPwm(int16_t pwm){
	...
	(((0x00000000U) == 0x00000000U) ? ((&htim2)->Instance ->CCR1 = (pwm)) : ((0x00000000U) == 0x00000004U) ? ((&htim2)->Instance ->CCR2 = (pwm)) : ((0x00000000U) == 0x00000008U) ? ((&htim2)->Instance ->CCR3 = (pwm)) : ((&htim2)->Instance ->CCR4 = (pwm)));
	if(pwm != 0){
