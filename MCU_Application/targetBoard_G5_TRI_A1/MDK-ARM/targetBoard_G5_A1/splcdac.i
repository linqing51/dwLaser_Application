...
#line 2 "..\\..\\sPlcPort\\sPlcDac.c"
 

static void writeMcp4821_0(uint16_t dat){
	uint8_t tmp, i;
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0010), GPIO_PIN_RESET);
	dat &= 0x0FFF;
	dat |= (1 << 12);
	dat |= (1 << 13);
	...
	for(i = 0;i < 16;i ++){
		...
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0004), (GPIO_PinState)tmp);
		__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0008), GPIO_PIN_SET);
		__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0008), GPIO_PIN_RESET);
		__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();
	}
	__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0010), GPIO_PIN_SET);
}

static void writeMcp4821_1(uint16_t dat){
	uint8_t tmp, i;
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0001), GPIO_PIN_RESET);
	dat &= 0x0FFF;
	dat |= (1 << 12);
	dat |= (1 << 13);
	__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();
	for(i = 0;i < 16;i ++){
		tmp = (uint8_t)(dat >> (15 - i)) & 0x01;
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x4000), (GPIO_PinState)tmp);
		__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();
...
static void writeMcp4821_2(uint16_t dat){
	uint8_t tmp, i;
	...
	for(i = 0;i < 16;i ++){
		tmp = (uint8_t)(dat >> (15 - i)) & 0x01;
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0020), (GPIO_PinState)tmp);
		__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();
...
void sPlcDacInit(void){
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0010), GPIO_PIN_SET);HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0001), GPIO_PIN_SET);HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0080), GPIO_PIN_SET);HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0008), GPIO_PIN_SET);
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0008), GPIO_PIN_RESET);HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x8000), GPIO_PIN_RESET);HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0040), GPIO_PIN_RESET);HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0004), GPIO_PIN_RESET); 
	__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();
	__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();__nop();
	writeMcp4821_0(0);
	writeMcp4821_1(0);
	writeMcp4821_2(0);
	printf("%s,%d,%s:init dac vref=2048mV\n","..\\..\\sPlcPort\\sPlcDac.c", 73, __func__);
	printf("%s,%d,%s:init dac done!\n","..\\..\\sPlcPort\\sPlcDac.c", 74, __func__);
}

void UPDAC0(void){
	uint16_t temp;
	temp = NVRAM0[(1320 + 30)] & 0x0FFF;
	writeMcp4821_0(temp);
	printf("%s,%d,%s:update dac0=%d\n","..\\..\\sPlcPort\\sPlcDac.c", 81, __func__, temp);
}
void UPDAC1(void){
	uint16_t temp;
	temp = NVRAM0[(1320 + 31)] & 0x0FFF;
	writeMcp4821_1(temp);
	writeMcp4821_2(temp);
	printf("%s,%d,%s:update dac1=%d\n","..\\..\\sPlcPort\\sPlcDac.c", 88, __func__, temp);
}
...
void CLDAC(void){
	...
	writeMcp4821_1(0);
	writeMcp4821_2(0);
	printf("%s,%d,%s:clear all dac!\n","..\\..\\sPlcPort\\sPlcDac.c", 95, __func__);
}



#line 168 "..\\..\\sPlcPort\\sPlcDac.c"
