...
HAL_StatusTypeDef HAL_InitTick(uint32_t TickPriority)
{
  ...
  do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (7U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (7U)))); (void)tmpreg; } while(0U);
  ...
  htim13.Instance = ((TIM_TypeDef *) (0x40000000UL + 0x1C00UL));
  ...
  htim13.Init.CounterMode = 0x00000000U;
  htim13.Init.AutoReloadPreload = 0x00000000U;
