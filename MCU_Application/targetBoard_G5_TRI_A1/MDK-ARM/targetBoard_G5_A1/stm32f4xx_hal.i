...
HAL_StatusTypeDef HAL_DeInit(void)
{
  ...
  (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1RSTR = 0x206011FFU);
...
uint32_t HAL_GetHalVersion(void)
{
  return (((0x01U) << 24U) |((0x08U) << 16U) |((0x03U) << 8U ) |((0x00U)));
}
...
#line 600 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal.c"
