...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, DEV_GPIO9_Pin|PWR_DIS_Pin|SPK_EN_Pin|MCP41010_CS_Pin
                          |MCP41010_SCK_Pin|MCP41010_SDI_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DEV_GPIO9_Pin PWR_DIS_Pin */
  GPIO_InitStruct.Pin = DEV_GPIO9_Pin|PWR_DIS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : USB_FS_SEL_Pin */
  GPIO_InitStruct.Pin = USB_FS_SEL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(USB_FS_SEL_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : PWR_ON_Pin INTERLOCK_NC_Pin */
  GPIO_InitStruct.Pin = PWR_ON_Pin|INTERLOCK_NC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);
